...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-88f9fb24><div class="content-form-page" data-v-88f9fb24><div class="page-header" data-v-88f9fb24><h1 class="page-title" data-v-88f9fb24>${ssrInterpolate(unref(isNewContent) ? _ctx.$t("contentManager.addNew") : _ctx.$t("contentManager.edit"))}</h1><div class="page-actions" data-v-88f9fb24>`);
      ...
      _push(`</div></div><div class="form-grid" data-v-88f9fb24>`);
      _push(ssrRenderComponent(_component_Card, { class: "form-card" }, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="content-form" data-v-88f9fb24${_scopeId}><div class="form-group" data-v-88f9fb24${_scopeId}><label for="title" data-v-88f9fb24${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.contentTitle"))} *</label>`);
            ...
            if (unref(errors).title) {
              _push2(`<small class="p-error" data-v-88f9fb24${_scopeId}>${ssrInterpolate(unref(errors).title)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-88f9fb24${_scopeId}><label for="contentType" data-v-88f9fb24${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.contentType"))} *</label>`);
            ...
            if (unref(errors).content_type) {
              _push2(`<small class="p-error" data-v-88f9fb24${_scopeId}>${ssrInterpolate(unref(errors).content_type)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-88f9fb24${_scopeId}><label for="description" data-v-88f9fb24${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.description"))}</label>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
            _push2(`</div><div class="form-group" data-v-88f9fb24${_scopeId}><label for="menu" data-v-88f9fb24${_scopeId}>${ssrInterpolate(_ctx.$t("menuManager.menuName"))} *</label>`);
            _push2(ssrRenderComponent(_component_Dropdown, {
              id: "menu",
            ...
            if (unref(errors).menu_id) {
              _push2(`<small class="p-error" data-v-88f9fb24${_scopeId}>${ssrInterpolate(unref(errors).menu_id)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      if (!unref(isNewContent)) {
        _push(ssrRenderComponent(_component_Card, { class: "preview-card" }, {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(`<div class="action-links" data-v-88f9fb24${_scopeId}>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-88f9fb24"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DiWOeEem.mjs.map
