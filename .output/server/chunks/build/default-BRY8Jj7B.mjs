...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="main-content" data-v-e9a4af00>`);
      ...
      if (unref(showPlugin) && ((_a = unref(settings)) == null ? void 0 : _a.chat_script)) {
        _push(`<div data-v-e9a4af00>${(_a2 = unref(settings).chat_script) != null ? _a2 : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e9a4af00"]]);

export { _default as default };
//# sourceMappingURL=default-BRY8Jj7B.mjs.map
