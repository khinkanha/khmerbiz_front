import { p as parseSmartDescription, _ as __nuxt_component_0$1 } from './tiptapFormat-VsmiBmjD.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "news-section" }, _attrs))} data-v-047726fa>`);
      if (__props.sectionTitle) {
        _push(`<h2 class="section-title" data-v-047726fa>${ssrInterpolate(__props.sectionTitle)}</h2>`);
      } else {
        _push(`<!---->`);
      }
      if ((((_a = sectionDescriptionSmart.value) == null ? void 0 : _a.format) === "tiptap" || ((_b = sectionDescriptionSmart.value) == null ? void 0 : _b.format) === "wrapped-tiptap") && sectionDescriptionSmart.value.tiptapDoc) {
        _push(`<div class="section-description" data-v-047726fa>`);
        ...
        _push(`<div class="section-description" data-v-047726fa>${(_a2 = __props.sectionDescription) != null ? _a2 : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-047726fa>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(featureNews).length > 0) {
          _push(`<div class="feature-news" data-v-047726fa><!--[-->`);
          ssrRenderList(unref(featureNews), (news) => {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="feature-badge" data-v-047726fa${_scopeId}>Featured</div><div class="feature-card-image" data-v-047726fa${_scopeId}>`);
                  if (news.photo) {
                    _push2(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-047726fa${_scopeId}>`);
                  } else {
                    _push2(`<div class="news-placeholder" data-v-047726fa${_scopeId}><i class="pi pi-image" data-v-047726fa${_scopeId}></i></div>`);
                  }
                  _push2(`</div><div class="feature-card-body" data-v-047726fa${_scopeId}><h4 class="feature-title" data-v-047726fa${_scopeId}>${ssrInterpolate(news.title)}</h4>`);
                  if (news.short_description) {
                    _push2(`<p class="feature-excerpt" data-v-047726fa${_scopeId}>${ssrInterpolate(news.short_description)}</p>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (news.publish_date) {
                    _push2(`<div class="feature-date" data-v-047726fa${_scopeId}><i class="pi pi-calendar" data-v-047726fa${_scopeId}></i> ${ssrInterpolate(formatDate(news.publish_date))}</div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
        ...
        _push(`<div class="news-grid" data-v-047726fa><!--[-->`);
        ssrRenderList(unref(newsItems), (news) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="news-image" data-v-047726fa${_scopeId}>`);
                if (news.photo) {
                  _push2(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-047726fa${_scopeId}>`);
                } else {
                  _push2(`<div class="news-placeholder" data-v-047726fa${_scopeId}><i class="pi pi-image" data-v-047726fa${_scopeId}></i></div>`);
                }
                _push2(`</div><div class="news-content" data-v-047726fa${_scopeId}><h4 class="news-title" data-v-047726fa${_scopeId}>${ssrInterpolate(news.title)}</h4>`);
                if (news.short_description) {
                  _push2(`<p class="news-excerpt" data-v-047726fa${_scopeId}>${ssrInterpolate(news.short_description)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                if (news.publish_date) {
                  _push2(`<div class="news-date" data-v-047726fa${_scopeId}><i class="pi pi-calendar" data-v-047726fa${_scopeId}></i> ${ssrInterpolate(formatDate(news.publish_date))}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
        ...
        if (unref(totalPages) > 1) {
          _push(`<div class="pagination-controls" data-v-047726fa><button class="pagination-btn"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""}${ssrRenderAttr("title", _ctx.$t("common.first"))} data-v-047726fa><i class="pi pi-angle-double-left" data-v-047726fa></i></button><button class="pagination-btn"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""}${ssrRenderAttr("title", _ctx.$t("common.previous"))} data-v-047726fa><i class="pi pi-angle-left" data-v-047726fa></i></button><span class="pagination-info" data-v-047726fa>${ssrInterpolate(unref(currentPage))} / ${ssrInterpolate(unref(totalPages))}</span><button class="pagination-btn"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""}${ssrRenderAttr("title", _ctx.$t("common.next"))} data-v-047726fa><i class="pi pi-angle-right" data-v-047726fa></i></button><button class="pagination-btn"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""}${ssrRenderAttr("title", _ctx.$t("common.last"))} data-v-047726fa><i class="pi pi-angle-double-right" data-v-047726fa></i></button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      ...
      if (__props.showMoreLink) {
        _push(`<div class="section-footer" data-v-047726fa>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: __props.moreLink,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("contentManager.view"))} ${ssrInterpolate(_ctx.$t("common.more"))} <i class="pi pi-arrow-right" data-v-047726fa${_scopeId}></i>`);
            } else {
              return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-047726fa"]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      var _a, _b;
      const _component_BlockRenderer = __nuxt_component_0$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "video-section" }, _attrs))} data-v-63fe834a>`);
      if (__props.sectionTitle) {
        _push(`<h2 class="section-title" data-v-63fe834a>${ssrInterpolate(__props.sectionTitle)}</h2>`);
      } else {
        _push(`<!---->`);
      }
      if ((((_a = sectionDescriptionSmart.value) == null ? void 0 : _a.format) === "tiptap" || ((_b = sectionDescriptionSmart.value) == null ? void 0 : _b.format) === "wrapped-tiptap") && sectionDescriptionSmart.value.tiptapDoc) {
        _push(`<div class="section-description" data-v-63fe834a>`);
        _push(ssrRenderComponent(_component_BlockRenderer, {
          doc: sectionDescriptionSmart.value.tiptapDoc
        }, null, _parent));
        _push(`</div>`);
      } else if (__props.sectionDescription) {
        _push(`<div class="section-description" data-v-63fe834a>${(_a2 = __props.sectionDescription) != null ? _a2 : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="video-grid" data-v-63fe834a><!--[-->`);
      ssrRenderList(__props.items, (item) => {
        var _a3;
        _push(`<div class="video-item" data-v-63fe834a><div class="video-wrapper" data-v-63fe834a>`);
        if (item.url && getEmbedUrl(item.url)) {
          _push(`<iframe${ssrRenderAttr("src", (_a3 = getEmbedUrl(item.url)) != null ? _a3 : void 0)}${ssrRenderAttr("title", item.title)} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-v-63fe834a></iframe>`);
        } else {
          _push(`<div class="video-placeholder" data-v-63fe834a><i class="pi pi-video" data-v-63fe834a></i><p data-v-63fe834a>Invalid video URL</p></div>`);
        }
        _push(`</div>`);
        if (item.title) {
          _push(`<div class="video-caption" data-v-63fe834a><h3 data-v-63fe834a>${ssrInterpolate(item.title)}</h3>`);
          if (item.description) {
            _push(`<p class="video-description" data-v-63fe834a>${ssrInterpolate(item.description)}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-63fe834a"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-bfa69ee5>`);
      if (__props.sectionTitle) {
        _push(`<h2 class="section-title" data-v-bfa69ee5>${ssrInterpolate(__props.sectionTitle)}</h2>`);
      } else {
        _push(`<!---->`);
      }
      if ((((_a = sectionDescriptionSmart.value) == null ? void 0 : _a.format) === "tiptap" || ((_b = sectionDescriptionSmart.value) == null ? void 0 : _b.format) === "wrapped-tiptap") && sectionDescriptionSmart.value.tiptapDoc) {
        _push(`<div class="section-description" data-v-bfa69ee5>`);
        _push(ssrRenderComponent(_component_BlockRenderer, {
          doc: sectionDescriptionSmart.value.tiptapDoc
        }, null, _parent));
        _push(`</div>`);
      } else if (__props.sectionDescription) {
        _push(`<div class="section-description" data-v-bfa69ee5>${(_a2 = __props.sectionDescription) != null ? _a2 : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(loading) && unref(allProducts).length > 0) {
        _push(`<div class="search-container" data-v-bfa69ee5><div class="search-bar" data-v-bfa69ee5><i class="pi pi-search search-icon" data-v-bfa69ee5></i><input${ssrRenderAttr("value", unref(searchQuery))}${ssrRenderAttr("placeholder", _ctx.$t("product.search.placeholder"))} class="search-input" data-v-bfa69ee5>`);
        if (unref(searchQuery)) {
          _push(`<button class="clear-search" data-v-bfa69ee5><i class="pi pi-times" data-v-bfa69ee5></i></button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><button class="${ssrRenderClass([{ active: hasActiveFilters.value }, "filter-button"])}" data-v-bfa69ee5><i class="pi pi-filter" data-v-bfa69ee5></i><span data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.title"))}</span>`);
        if (appliedFilters.value.length) {
          _push(`<span class="filter-badge" data-v-bfa69ee5>${ssrInterpolate(appliedFilters.value.length)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button></div>`);
      ...
      if (appliedFilters.value.length) {
        _push(`<div class="applied-filters" data-v-bfa69ee5><!--[-->`);
        ssrRenderList(appliedFilters.value, (filter) => {
          _push(`<div class="filter-tag" data-v-bfa69ee5><span data-v-bfa69ee5>${ssrInterpolate(filter.label)}</span><button class="remove-filter" data-v-bfa69ee5><i class="pi pi-times" data-v-bfa69ee5></i></button></div>`);
        });
        _push(`<!--]--><button class="reset-all" data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.clearAll"))}</button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(showFilters)) {
        _push(`<div class="filter-panel" data-v-bfa69ee5><div class="filter-header" data-v-bfa69ee5><h3 data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.title"))}</h3><button class="close-btn" data-v-bfa69ee5><i class="pi pi-times" data-v-bfa69ee5></i></button></div><div class="filter-section" data-v-bfa69ee5><h4 data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.priceRange"))}</h4><div class="price-inputs" data-v-bfa69ee5><div class="price-input" data-v-bfa69ee5><label data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.minPrice"))}</label><input type="number"${ssrRenderAttr("value", unref(priceRange)[0])}${ssrRenderAttr("min", filterMetadata.value.priceRange.min)}${ssrRenderAttr("max", filterMetadata.value.priceRange.max)} data-v-bfa69ee5></div><span class="price-separator" data-v-bfa69ee5>-</span><div class="price-input" data-v-bfa69ee5><label data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.maxPrice"))}</label><input type="number"${ssrRenderAttr("value", unref(priceRange)[1])}${ssrRenderAttr("min", filterMetadata.value.priceRange.min)}${ssrRenderAttr("max", filterMetadata.value.priceRange.max)} data-v-bfa69ee5></div></div><div class="price-display" data-v-bfa69ee5>${ssrInterpolate(formatCurrency(unref(priceRange)[0]))} - ${ssrInterpolate(formatCurrency(unref(priceRange)[1]))}</div></div>`);
        if (filterMetadata.value.currencies.length) {
          _push(`<div class="filter-section" data-v-bfa69ee5><h4 data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.currency"))}</h4><div class="currency-options" data-v-bfa69ee5><!--[-->`);
          ssrRenderList(filterMetadata.value.currencies, (currency) => {
            _push(`<label class="currency-checkbox" data-v-bfa69ee5><input type="checkbox"${ssrRenderAttr("value", currency)}${ssrIncludeBooleanAttr(unref(selectedCurrencies).includes(currency)) ? " checked" : ""} data-v-bfa69ee5><span data-v-bfa69ee5>${ssrInterpolate(currency)}</span></label>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="filter-section" data-v-bfa69ee5><h4 data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.sortBy"))}</h4><div class="sort-options" data-v-bfa69ee5><!--[-->`);
        ssrRenderList(sortOptions.value, (option) => {
          _push(`<button class="${ssrRenderClass(["sort-btn", { active: unref(sortBy) === option.value }])}" data-v-bfa69ee5>${ssrInterpolate(option.label)} `);
          if (unref(sortBy) === option.value) {
            _push(`<i class="${ssrRenderClass(unref(sortOrder) === "asc" ? "pi pi-arrow-up" : "pi pi-arrow-down")}" data-v-bfa69ee5></i>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</button>`);
        });
        _push(`<!--]--></div></div><div class="filter-footer" data-v-bfa69ee5><div class="results-count" data-v-bfa69ee5>${ssrInterpolate(unref(products).length)} ${ssrInterpolate(_ctx.$t("product.pagination.of"))} ${ssrInterpolate(filterMetadata.value.totalCount)} ${ssrInterpolate(_ctx.$t("product.search.resultsCount", { count: filterMetadata.value.totalCount }))}</div><button class="reset-btn" data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.filter.resetAll"))}</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-bfa69ee5>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(products).length === 0 && unref(allProducts).length === 0) {
          _push(`<div class="empty-state" data-v-bfa69ee5><i class="pi pi-shopping-bag" data-v-bfa69ee5></i><p data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.empty.noProducts"))}</p></div>`);
        } else if (unref(products).length === 0 && hasActiveFilters.value) {
          _push(`<div class="empty-state" data-v-bfa69ee5><i class="pi pi-search" data-v-bfa69ee5></i><p data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.search.noResults"))}</p><p class="empty-hint" data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.empty.tryAdjusting"))}</p><button class="reset-btn" data-v-bfa69ee5>${ssrInterpolate(_ctx.$t("product.empty.clearFilters"))}</button></div>`);
        } else {
          _push(`<div class="product-grid" data-v-bfa69ee5><!--[-->`);
          ssrRenderList(unref(products), (product) => {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<div class="product-image" data-v-bfa69ee5${_scopeId}>`);
                  if (product.photos && product.photos.length) {
                    _push2(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${product.photos[0]}`)}${ssrRenderAttr("alt", product.name)} data-v-bfa69ee5${_scopeId}>`);
                  } else {
                    _push2(`<div class="product-placeholder" data-v-bfa69ee5${_scopeId}><i class="pi pi-image" data-v-bfa69ee5${_scopeId}></i></div>`);
                  }
                  if (product.photos && product.photos.length > 1) {
                    _push2(`<span class="photo-count" data-v-bfa69ee5${_scopeId}><i class="pi pi-images" data-v-bfa69ee5${_scopeId}></i> ${ssrInterpolate(product.photos.length)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<div class="image-overlay" data-v-bfa69ee5${_scopeId}><i class="pi pi-search" data-v-bfa69ee5${_scopeId}></i></div></div><div class="product-body" data-v-bfa69ee5${_scopeId}><h4 class="product-name" data-v-bfa69ee5${_scopeId}>${ssrInterpolate(product.name)}</h4>`);
                  if (product.shortdes) {
                    _push2(`<p class="product-shortdes" data-v-bfa69ee5${_scopeId}>${ssrInterpolate(product.shortdes)}</p>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (product.features && product.features.length) {
                    _push2(`<ul class="product-features" data-v-bfa69ee5${_scopeId}><!--[-->`);
                    ssrRenderList(product.features.slice(0, 3), (feat, i) => {
                      _push2(`<li data-v-bfa69ee5${_scopeId}>${ssrInterpolate(feat)}</li>`);
                    });
                    _push2(`<!--]--></ul>`);
                  } else {
                    _push2(`<!---->`);
                  ...
                  if (product.price !== void 0 && product.price !== null) {
                    _push2(`<div class="product-price" data-v-bfa69ee5${_scopeId}>${ssrInterpolate(formatPrice(product.price))}\xA0`);
                    if (product.currency) {
                      _push2(`<small data-v-bfa69ee5${_scopeId}>${ssrInterpolate(product.currency)}</small>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    _push2(`</div>`);
        ...
        if (unref(totalPages) > 1) {
          _push(`<div class="pagination-controls" data-v-bfa69ee5><button class="pagination-btn"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-bfa69ee5><i class="pi pi-angle-left" data-v-bfa69ee5></i></button><span class="pagination-info" data-v-bfa69ee5>${ssrInterpolate(unref(currentPage))} / ${ssrInterpolate(unref(totalPages))}</span><button class="pagination-btn"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-bfa69ee5><i class="pi pi-angle-right" data-v-bfa69ee5></i></button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(currentProduct)) {
              _push2(`<div class="lightbox-content" data-v-bfa69ee5${_scopeId}>`);
              ...
              _push2(`<div class="lightbox-image-wrapper" data-v-bfa69ee5${_scopeId}><img${ssrRenderAttr("src", `${unref(photoUrl)}${unref(currentProduct).photos[unref(currentPhotoIndex)]}`)}${ssrRenderAttr("alt", unref(currentProduct).name)} class="lightbox-image" data-v-bfa69ee5${_scopeId}><div class="lightbox-info" data-v-bfa69ee5${_scopeId}><h3 class="lightbox-title" data-v-bfa69ee5${_scopeId}>${ssrInterpolate(unref(currentProduct).name)}</h3><span class="lightbox-counter" data-v-bfa69ee5${_scopeId}>${ssrInterpolate(unref(currentPhotoIndex) + 1)} ${ssrInterpolate(_ctx.$t("product.pagination.of"))} ${ssrInterpolate(unref(currentProduct).photos.length)}</span></div></div>`);
              _push2(ssrRenderComponent(_component_Button, mergeProps({
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bfa69ee5"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.content) {
        ...
        if ((((_a = smart.value) == null ? void 0 : _a.format) === "tiptap" || ((_b = smart.value) == null ? void 0 : _b.format) === "wrapped-tiptap") && smart.value.tiptapDoc) {
...
//# sourceMappingURL=ArticleSection-CkZe_zP5.mjs.map
