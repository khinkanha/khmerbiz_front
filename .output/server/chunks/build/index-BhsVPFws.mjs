...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "row" }, _attrs))} data-v-b9d21a7e><div class="col-md-3" data-v-b9d21a7e><ul class="nav nav-pills nav-stacked" data-v-b9d21a7e><li class="${ssrRenderClass({ active: true })}" data-v-b9d21a7e>`);
      ...
      _push(`</li><li data-v-b9d21a7e><a href="#" data-v-b9d21a7e>Clear Cache</a></li></ul></div><div class="col-md-9" data-v-b9d21a7e>`);
      if (unref(clearMsg)) {
        _push(`<div class="alert alert-success" data-v-b9d21a7e>Menu Cache has been cleared.</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="text-right" style="${ssrRenderStyle({ "margin-bottom": "10px" })}" data-v-b9d21a7e>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fa fa-plus" data-v-b9d21a7e${_scopeId}></i>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data._depth > 0) {
                          _push4(`<i class="fa fa-angle-right" style="${ssrRenderStyle({ "color": "#a0aec0", "margin-right": "4px" })}" data-v-b9d21a7e${_scopeId3}></i>`);
                        } else {
                          _push4(`<!---->`);
                        }
                  ...
                  if (data.content_id) {
                    _push3(ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<i class="fa fa-eye" style="${ssrRenderStyle({ "color": "#3b82f6" })}" data-v-b9d21a7e${_scopeId3}></i>`);
                        } else {
                          return [
                            createVNode("i", {
                              class: "fa fa-eye",
            ...
            _push2(ssrRenderComponent(_component_Column, {
              ...
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="reorder-btns" data-v-b9d21a7e${_scopeId2}><a${ssrRenderAttrs(mergeProps({
                    href: "#",
                    class: ["btn btn-xs btn-default", { disabled: unref(loading) }]
                  }, ssrGetDirectiveProps(_ctx, _directive_tooltip, _ctx.$t("menuManager.moveUp"), void 0, { top: true })))} data-v-b9d21a7e${_scopeId2}><i class="fa fa-arrow-up" data-v-b9d21a7e${_scopeId2}></i></a><a${ssrRenderAttrs(mergeProps({
                    href: "#",
                    class: ["btn btn-xs btn-default", { disabled: unref(loading) }]
                  }, ssrGetDirectiveProps(_ctx, _directive_tooltip, _ctx.$t("menuManager.moveDown"), void 0, { top: true })))} data-v-b9d21a7e${_scopeId2}><i class="fa fa-arrow-down" data-v-b9d21a7e${_scopeId2}></i></a></div>`);
                } else {
                  return [
              ...
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (getLanguageByLangId(data.lang_id)) {
                    _push3(`<img${ssrRenderAttr("src", `/flag/${flagMap(getLanguageByLangId(data.lang_id).flag)}`)} style="${ssrRenderStyle({ "width": "20px", "height": "14px", "border-radius": "2px" })}" data-v-b9d21a7e${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_component_Column, { style: { width: "80px" } }, {
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<a href="#" class="text-danger" data-v-b9d21a7e${_scopeId2}>${ssrInterpolate(_ctx.$t("menuManager.delete"))}</a>`);
                } else {
                  return [
                    createVNode("a", {
                      href: "#",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b9d21a7e"]]);

export { index as default };
//# sourceMappingURL=index-BhsVPFws.mjs.map
