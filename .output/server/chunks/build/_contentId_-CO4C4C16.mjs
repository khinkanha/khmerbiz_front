...
import './ArticleSection-CkZe_zP5.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useHead(() => {
      var _a, _b, _c, _d;
      return {
        title: ((_b = (_a = contentSection.value) == null ? void 0 : _a.content) == null ? void 0 : _b.title) || "Content",
        meta: ((_d = (_c = contentSection.value) == null ? void 0 : _c.content) == null ? void 0 : _d.description) ? [{ name: "description", content: contentSection.value.content.description }] : []
      };
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content-page" }, _attrs))} data-v-68cf681f>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-68cf681f>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (unref(contentSection)) {
        _push(`<div class="content-container" data-v-68cf681f>`);
        _push(ssrRenderComponent(_component_ContentRenderer, {
          content: unref(contentSection).content,
          "domain-id": parseInt(unref(domainId)),
          "show-title": true
        }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div class="empty-state" data-v-68cf681f><i class="pi pi-exclamation-circle" data-v-68cf681f></i><p data-v-68cf681f>Content not found</p>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/pages/[domainId]/[contentId].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _contentId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-68cf681f"]]);

export { _contentId_ as default };
//# sourceMappingURL=_contentId_-CO4C4C16.mjs.map
