...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-95a6d8f5><div class="flag" data-v-95a6d8f5>`);
      _push(ssrRenderComponent(_component_LanguageSelector, null, null, _parent));
      _push(`</div>`);
      if (unref(logoPos) !== 3) {
        _push(`<div class="top-bar" data-v-95a6d8f5><div class="container top-bar-inner" data-v-95a6d8f5><div class="brand" data-v-95a6d8f5>`);
        if ((_a = unref(settings)) == null ? void 0 : _a.logo) {
          _push(`<!--[--><img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_b = unref(settings)) == null ? void 0 : _b.title) || "Logo")} class="brand-logo desktop-logo" data-v-95a6d8f5>`);
          if ((_c = unref(settings)) == null ? void 0 : _c.mobile_logo) {
            _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_d = unref(settings)) == null ? void 0 : _d.title) || "Logo")} class="brand-logo mobile-logo" data-v-95a6d8f5>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
      ...
      _push(`<div class="mobile-logo-bar" data-v-95a6d8f5><div class="container mobile-logo-inner" data-v-95a6d8f5>`);
      if ((_e = unref(settings)) == null ? void 0 : _e.mobile_logo) {
        _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_f = unref(settings)) == null ? void 0 : _f.title) || "Logo")} class="mobile-logo-img" data-v-95a6d8f5>`);
      } else if ((_g = unref(settings)) == null ? void 0 : _g.title) {
        _push(`<div class="mobile-logo-title" data-v-95a6d8f5><h1 data-v-95a6d8f5>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><nav class="nav-bar" data-v-95a6d8f5><div class="container nav-inner" data-v-95a6d8f5><div class="mobile-brand" data-v-95a6d8f5>`);
      if ((_h = unref(settings)) == null ? void 0 : _h.title) {
        _push(`<div class="brand-title" data-v-95a6d8f5><h1 data-v-95a6d8f5>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><ul class="${ssrRenderClass([unref(navListClass), "nav-list"])}" data-v-95a6d8f5><!--[-->`);
      ssrRenderList(unref(filteredMenuTree), (item) => {
        var _a2;
        _push(`<li class="${ssrRenderClass([{ "has-dropdown": item.children && item.children.length > 0, "accordion-open": unref(expandedMenuId) === item.item_id }, "nav-item"])}" data-v-95a6d8f5>`);
        if (item.children && item.children.length > 0) {
          _push(`<!--[-->`);
          if (unref(isSinglePage)) {
            _push(`<a${ssrRenderAttr("href", `#section-${item.item_id}`)} class="${ssrRenderClass([{ active: unref(activeMenuId) === item.item_id }, "nav-link"])}" data-v-95a6d8f5>${ssrInterpolate(item.item_name)}</a>`);
          } else {
            _push(`<div class="${ssrRenderClass([{ active: isMenuActive(item) }, "nav-link nav-link-parent"])}" data-v-95a6d8f5><span data-v-95a6d8f5>${ssrInterpolate(item.item_name)}</span><i class="${ssrRenderClass([unref(expandedMenuId) === item.item_id ? "pi-chevron-up" : "pi-chevron-down", "pi accordion-icon"])}" data-v-95a6d8f5></i></div>`);
          }
          _push(`<!--]-->`);
        } else {
          _push(`<!--[-->`);
        ...
        if (item.children && item.children.length > 0) {
          _push(`<div class="dropdown-menu" data-v-95a6d8f5><div class="dropdown-inner" data-v-95a6d8f5>`);
          if (unref(isSinglePage)) {
            _push(`<!--[-->`);
            ssrRenderList(item.children, (child) => {
              _push(`<a${ssrRenderAttr("href", `#section-${child.item_id}`)} class="dropdown-link" data-v-95a6d8f5>${ssrInterpolate(child.item_name)}</a>`);
            });
            _push(`<!--]-->`);
          } else {
            _push(`<!--[-->`);
      ...
      _push(`<button class="mobile-toggle" data-v-95a6d8f5><i class="${ssrRenderClass(unref(mobileMenuOpen) ? "pi pi-times" : "pi pi-bars")}" data-v-95a6d8f5></i></button></div></nav>`);
      if (unref(logoPos) === 3) {
        _push(`<div class="top-bar bottom-bar" data-v-95a6d8f5><div class="container top-bar-inner" data-v-95a6d8f5><div class="brand" data-v-95a6d8f5>`);
        if ((_i = unref(settings)) == null ? void 0 : _i.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_j = unref(settings)) == null ? void 0 : _j.title) || "Logo")} class="brand-logo" data-v-95a6d8f5>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-95a6d8f5"]]);
...
//# sourceMappingURL=default-C-15OMrA.mjs.map
