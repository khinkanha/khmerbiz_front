...
import { _ as _export_sfc, k as useConfirm, l as useI18n, u as useRouter } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content-list-page" }, _attrs))} data-v-e1ca30f7><div class="page-header" data-v-e1ca30f7><h1 class="page-title" data-v-e1ca30f7>${ssrInterpolate(_ctx.$t("contentManager.title"))}</h1><div class="page-actions" data-v-e1ca30f7>`);
      ...
      _push(ssrRenderComponent(_component_Card, { class: "filter-card" }, {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-row" data-v-e1ca30f7${_scopeId}>`);
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_Tag, {
                          value: data.status === 1 ? _ctx.$t("contentManager.draft") : _ctx.$t("contentManager.published"),
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="action-buttons" data-v-e1ca30f7${_scopeId3}>`);
                        ...
                        if (data.content_type !== unref(ContentType).ARTICLE && data.content_type !== unref(ContentType).PRODUCT) {
                          _push4(ssrRenderComponent(_component_Button, mergeProps({
                            icon: "pi pi-list",
                            rounded: "",
                            text: "",
                        ...
                        if (data.content_type === unref(ContentType).PRODUCT) {
                          _push4(ssrRenderComponent(_component_Button, mergeProps({
                            icon: "pi pi-list",
                            rounded: "",
                            text: "",
                            onClick: ($event) => _ctx.$router.push(`/admin/content/${data.content_id}/products`)
                          }, ssrGetDirectiveProps(_ctx, _directive_tooltip, _ctx.$t("contentManager.list"), void 0, { top: true })), null, _parent4, _scopeId3));
                        } else {
                          _push4(`<!---->`);
                        }
                        ...
                        return [
                          createVNode("div", { class: "action-buttons" }, [
                            ...
                            data.content_type !== unref(ContentType).ARTICLE && data.content_type !== unref(ContentType).PRODUCT ? withDirectives((openBlock(), createBlock(_component_Button, {
                              key: 0,
                              icon: "pi pi-list",
                              rounded: "",
                              text: "",
                            ...
                            data.content_type === unref(ContentType).PRODUCT ? withDirectives((openBlock(), createBlock(_component_Button, {
                              key: 1,
                              icon: "pi pi-list",
                              rounded: "",
                              text: "",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e1ca30f7"]]);

export { index as default };
//# sourceMappingURL=index-CY443X6y.mjs.map
