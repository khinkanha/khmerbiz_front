...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const logoPos = computed(() => {
      var _a;
      return Number((_a = settings.value) == null ? void 0 : _a.logo_pos) || 1;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-72858dc3>`);
      if (unref(logoPos) !== 3) {
        _push(`<div class="top-bar" data-v-72858dc3><div class="container top-bar-inner" data-v-72858dc3><div class="brand" data-v-72858dc3>`);
        if (((_a = unref(settings)) == null ? void 0 : _a.logo) && !((_b = unref(settings)) == null ? void 0 : _b.mobile_logo)) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_c = unref(settings)) == null ? void 0 : _c.title) || "Logo")} class="brand-logo" data-v-72858dc3>`);
        } else if ((_d = unref(settings)) == null ? void 0 : _d.logo) {
          _push(`<!--[--><img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_e = unref(settings)) == null ? void 0 : _e.title) || "Logo")} class="brand-logo desktop-logo" data-v-72858dc3>`);
          if ((_f = unref(settings)) == null ? void 0 : _f.mobile_logo) {
            _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_g = unref(settings)) == null ? void 0 : _g.title) || "Logo")} class="brand-logo mobile-logo" data-v-72858dc3>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
        ...
        if ((_h = unref(settings)) == null ? void 0 : _h.title) {
          _push(`<div class="brand-title" data-v-72858dc3><h1 data-v-72858dc3>${ssrInterpolate(unref(settings).title)}</h1></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="top-actions" data-v-72858dc3>`);
        _push(ssrRenderComponent(_component_LanguageSelector, null, null, _parent));
        _push(`</div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<nav class="nav-bar" data-v-72858dc3><div class="container nav-inner" data-v-72858dc3>`);
      if (unref(logoPos) === 2) {
        _push(`<div class="brand brand-inline" data-v-72858dc3>`);
        if ((_i = unref(settings)) == null ? void 0 : _i.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_j = unref(settings)) == null ? void 0 : _j.title) || "Logo")} class="brand-logo brand-logo-small" data-v-72858dc3>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<ul class="${ssrRenderClass([unref(navListClass), "nav-list"])}" data-v-72858dc3><!--[-->`);
      ssrRenderList(unref(filteredMenuTree), (item) => {
        var _a2;
        _push(`<li class="${ssrRenderClass([{ "has-dropdown": item.children && item.children.length > 0 }, "nav-item"])}" data-v-72858dc3>`);
        if (unref(isSinglePage)) {
          _push(`<a${ssrRenderAttr("href", `#section-${item.item_id}`)} class="${ssrRenderClass([{ active: unref(activeMenuId) === item.item_id }, "nav-link"])}" data-v-72858dc3>${ssrInterpolate(item.item_name)}</a>`);
        } else {
        ...
        if (item.children && item.children.length > 0) {
          _push(`<div class="dropdown-menu" data-v-72858dc3><div class="dropdown-inner" data-v-72858dc3>`);
          if (unref(isSinglePage)) {
            _push(`<!--[-->`);
            ssrRenderList(item.children, (child) => {
              _push(`<a${ssrRenderAttr("href", `#section-${child.item_id}`)} class="dropdown-link" data-v-72858dc3>${ssrInterpolate(child.item_name)}</a>`);
            });
            _push(`<!--]-->`);
          } else {
            _push(`<!--[-->`);
      ...
      _push(`<button class="mobile-toggle" data-v-72858dc3><i class="${ssrRenderClass(unref(mobileMenuOpen) ? "pi pi-times" : "pi pi-bars")}" data-v-72858dc3></i></button></div></nav>`);
      if (unref(logoPos) === 3) {
        _push(`<div class="top-bar bottom-bar" data-v-72858dc3><div class="container top-bar-inner" data-v-72858dc3><div class="brand" data-v-72858dc3>`);
        if ((_k = unref(settings)) == null ? void 0 : _k.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_l = unref(settings)) == null ? void 0 : _l.title) || "Logo")} class="brand-logo" data-v-72858dc3>`);
        } else {
          _push(`<!---->`);
        }
        if ((_m = unref(settings)) == null ? void 0 : _m.title) {
          _push(`<div class="brand-title" data-v-72858dc3><h1 data-v-72858dc3>${ssrInterpolate(unref(settings).title)}</h1></div>`);
        } else {
          _push(`<!---->`);
        }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-72858dc3"]]);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1b4cfe5f"]]);
const useTheme = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-af6aa6de>`);
      _push(ssrRenderComponent(_component_PublicHeader, null, null, _parent));
      _push(`<main class="main-content" data-v-af6aa6de>`);
      ...
      if (unref(showPlugin) && ((_a = unref(settings)) == null ? void 0 : _a.chat_script)) {
        _push(`<div data-v-af6aa6de>${(_a2 = unref(settings).chat_script) != null ? _a2 : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-af6aa6de"]]);

export { _default as default };
//# sourceMappingURL=default-SFJ1aehg.mjs.map
