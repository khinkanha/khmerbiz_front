...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "news-detail" }, _attrs))} data-v-6ebb38bb><div class="container" data-v-6ebb38bb>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-6ebb38bb>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (unref(news)) {
        _push(`<div class="news-layout" data-v-6ebb38bb><article class="news-main" data-v-6ebb38bb><header class="article-header" data-v-6ebb38bb><h1 class="article-title" data-v-6ebb38bb>${ssrInterpolate(unref(news).title)}</h1><div class="article-meta" data-v-6ebb38bb>`);
        if ((_a = unref(news).author) == null ? void 0 : _a.full_name) {
          _push(`<span class="meta-author" data-v-6ebb38bb><i class="pi pi-user" data-v-6ebb38bb></i> ${ssrInterpolate(unref(news).author.full_name)}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (((_b = unref(news).author) == null ? void 0 : _b.full_name) && unref(news).publish_date) {
          _push(`<span class="meta-separator" data-v-6ebb38bb>|</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<span class="meta-date" data-v-6ebb38bb><i class="pi pi-calendar" data-v-6ebb38bb></i> ${ssrInterpolate(formatDate(unref(news).publish_date))}</span></div></header>`);
        if (unref(news).photo) {
          _push(`<div class="article-image" data-v-6ebb38bb><img${ssrRenderAttr("src", `${unref(photoUrl)}${unref(news).photo}`)}${ssrRenderAttr("alt", unref(news).title)} data-v-6ebb38bb></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(news).short_description) {
          _push(`<div class="article-excerpt" data-v-6ebb38bb>${ssrInterpolate(unref(news).short_description)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="article-body" data-v-6ebb38bb>${(_a2 = unref(news).description) != null ? _a2 : ""}</div></article>`);
        if (unref(relatedNews).length > 0) {
          _push(`<aside class="news-sidebar" data-v-6ebb38bb><h3 class="sidebar-title" data-v-6ebb38bb>${ssrInterpolate(_ctx.$t("contentManager.latestNews"))}</h3><div class="sidebar-list" data-v-6ebb38bb><!--[-->`);
          ssrRenderList(unref(relatedNews), (item, index) => {
            _push(`<div class="sidebar-item" data-v-6ebb38bb><a href="#" class="sidebar-item-link" data-v-6ebb38bb><div class="sidebar-thumb" data-v-6ebb38bb>`);
            if (item.photo) {
              _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${item.photo}`)}${ssrRenderAttr("alt", item.title)} data-v-6ebb38bb>`);
            } else {
              _push(`<div class="thumb-placeholder" data-v-6ebb38bb><i class="pi pi-image" data-v-6ebb38bb></i></div>`);
            }
            _push(`</div><div class="sidebar-info" data-v-6ebb38bb><span class="sidebar-news-title" data-v-6ebb38bb>${ssrInterpolate(item.title)}</span><span class="sidebar-news-date" data-v-6ebb38bb><i class="pi pi-calendar" data-v-6ebb38bb></i> ${ssrInterpolate(formatDate(item.publish_date))}</span></div></a>`);
            if (index < unref(relatedNews).length - 1) {
              _push(`<hr class="sidebar-separator" data-v-6ebb38bb>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        _push(`<div class="empty-state" data-v-6ebb38bb><p data-v-6ebb38bb>News not found</p></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const _newsId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6ebb38bb"]]);

export { _newsId_ as default };
//# sourceMappingURL=_newsId_-DT-HQTVe.mjs.map
