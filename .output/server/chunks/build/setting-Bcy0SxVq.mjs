...
const useSettingStore = defineStore("setting", () => {
  ...
  const updateLogoSettings = async (data) => {
    try {
      ...
      if (data.logo_pos !== void 0) formData.append("logo_position", data.logo_pos);
      if (data.logo_align !== void 0) formData.append("logo_align", data.logo_align);
...
//# sourceMappingURL=setting-Bcy0SxVq.mjs.map
