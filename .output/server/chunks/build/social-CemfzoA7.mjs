...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form><div class="row"><div class="col-md-6"><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.socialMedia"))}</label><select class="form-control"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "") : ssrLooseEqual(unref(socialForm).platform, "")) ? " selected" : ""}>-- Select --</option><option value="facebook"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "facebook") : ssrLooseEqual(unref(socialForm).platform, "facebook")) ? " selected" : ""}>Facebook</option><option value="youtube"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "youtube") : ssrLooseEqual(unref(socialForm).platform, "youtube")) ? " selected" : ""}>Youtube</option><option value="twitter"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "twitter") : ssrLooseEqual(unref(socialForm).platform, "twitter")) ? " selected" : ""}>Twitter</option><option value="linkedin"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "linkedin") : ssrLooseEqual(unref(socialForm).platform, "linkedin")) ? " selected" : ""}>LinkedIn</option><option value="google"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "google") : ssrLooseEqual(unref(socialForm).platform, "google")) ? " selected" : ""}>Google+</option><option value="telegram"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "telegram") : ssrLooseEqual(unref(socialForm).platform, "telegram")) ? " selected" : ""}>Telegram</option><option value="instagram"${ssrIncludeBooleanAttr(Array.isArray(unref(socialForm).platform) ? ssrLooseContain(unref(socialForm).platform, "instagram") : ssrLooseEqual(unref(socialForm).platform, "instagram")) ? " selected" : ""}>Instagram</option></select></div></div><div class="col-md-6"><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.link"))}</label><input type="text"${ssrRenderAttr("value", unref(socialForm).url)} class="form-control" placeholder="https://..."></div></div></div><button type="submit" class="btn btn-danger"${ssrIncludeBooleanAttr(unref(adding)) ? " disabled" : ""}><i class="fa fa-floppy-o"></i> ${ssrInterpolate(_ctx.$t("settings.save"))}</button></form><div class="table-responsive" style="${ssrRenderStyle({ "margin-top": "15px" })}"><table class="table"><thead><tr><th></th><th></th><th></th><th></th></tr></thead><tbody><!--[-->`);
      ssrRenderList(unref(settingStore).socialMedia, (social, i) => {
        _push(`<tr><td>${ssrInterpolate(i + 1)}</td><td>${ssrInterpolate(social.platform)}</td><td>${ssrInterpolate(social.url)}</td><td><a href="#" class="text-danger">${ssrInterpolate(_ctx.$t("settings.removeImage"))}</a></td></tr>`);
      });
...
//# sourceMappingURL=social-CemfzoA7.mjs.map
