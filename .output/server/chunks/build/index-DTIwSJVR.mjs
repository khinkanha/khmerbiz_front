...
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(_attrs)}><div id="btnnew"><a href="#" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Add User</a><br><br></div>`);
      ...
      _push(`<div class="table-responsive"><table class="table"><thead><tr><th>#</th><th>Username</th><th>Full Name</th><th>Phone</th><th>Email</th><th>Domain</th><th>Actions</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(unref(users), (user, i) => {
        _push(`<tr><td>${ssrInterpolate((unref(page) - 1) * 10 + i + 1)}</td><td>${ssrInterpolate(user.username)}</td><td>${ssrInterpolate(user.full_name)}</td><td>${ssrInterpolate(user.phone)}</td><td>${ssrInterpolate(user.email)}</td><td>${ssrInterpolate(user.domain_id)}</td><td><a href="#" title="Edit"><i class="fa fa-pencil"></i></a>\xA0 <a href="#" title="Set Password"><i class="fa fa-key"></i></a></td></tr>`);
      });
...
//# sourceMappingURL=index-DTIwSJVR.mjs.map
