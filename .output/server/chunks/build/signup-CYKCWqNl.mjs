...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderComponent } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(errorMessage)) {
        _push(`<div class="alert alert-danger">${ssrInterpolate(unref(errorMessage))} `);
        if (unref(fieldErrors).length) {
          _push(`<ul style="${ssrRenderStyle({ "margin-top": "5px", "margin-bottom": "0" })}"><!--[-->`);
          ssrRenderList(unref(fieldErrors), (err) => {
      ...
      _push(`<form><div class="row"><div class="col-md-6"><div class="form-group"><label for="username">${ssrInterpolate(_ctx.$t("userManager.username"))}</label><input type="text" id="username"${ssrRenderAttr("value", unref(form).username)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("userManager.username"))}></div></div><div class="col-md-6"><div class="form-group"><label for="fullname">${ssrInterpolate(_ctx.$t("userManager.fullName"))}</label><input type="text" id="fullname"${ssrRenderAttr("value", unref(form).full_name)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("userManager.fullName"))}></div></div></div><div class="row"><div class="col-md-6"><div class="form-group"><label for="password">Password</label><input type="password" id="password"${ssrRenderAttr("value", unref(form).password)} class="form-control" placeholder="Min 6 characters"></div></div><div class="col-md-6"><div class="form-group"><label for="email">${ssrInterpolate(_ctx.$t("userManager.email"))}</label><input type="email" id="email"${ssrRenderAttr("value", unref(form).email)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("userManager.email"))}></div></div></div><div class="row"><div class="col-md-6"><div class="form-group"><label for="phone">${ssrInterpolate(_ctx.$t("userManager.phone"))}</label><input type="text" id="phone"${ssrRenderAttr("value", unref(form).phone)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("userManager.phone"))}></div></div><div class="col-md-6"><div class="form-group"><label for="domain_name">Website Domain</label><input type="text" id="domain_name"${ssrRenderAttr("value", unref(form).domain_name)} class="form-control" placeholder="e.g. mycompany.khmerbiz-front.localhost"><small class="text-muted">This will be your website address</small></div></div></div><button type="submit" class="btn btn-danger"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""}><i class="fa fa-floppy-o"></i> ${ssrInterpolate(_ctx.$t("auth.signup"))}</button> \xA0 `);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/member/signup.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=signup-CYKCWqNl.mjs.map
