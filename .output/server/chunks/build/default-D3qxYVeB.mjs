...
import { defineComponent, computed, resolveComponent, unref, mergeProps, ref, watch, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isReady)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-loading" }, _attrs))} data-v-e1af7ffd>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div${ssrRenderAttrs(mergeProps({
          class: ["public-layout", unref(themeClass)],
          style: unref(designStyleVars)
        }, _attrs))} data-v-e1af7ffd>`);
        ...
        _push(`<main class="main-content" data-v-e1af7ffd>`);
        ...
        if (unref(showPlugin) && ((_a = unref(settings)) == null ? void 0 : _a.chat_script)) {
          _push(`<div data-v-e1af7ffd>${(_a2 = unref(settings).chat_script) != null ? _a2 : ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e1af7ffd"]]);

export { _default as default };
//# sourceMappingURL=default-D3qxYVeB.mjs.map
