...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderVNode, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrIncludeBooleanAttr } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showUnderConstruction)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "under-construction" }, _attrs))} data-v-3d376feb><div class="uc-content" data-v-3d376feb><div class="uc-icon" data-v-3d376feb><i class="pi pi-building" data-v-3d376feb></i></div><h1 class="uc-title" data-v-3d376feb>${ssrInterpolate(((_a = unref(domainStore).settings) == null ? void 0 : _a.title) || ((_b = unref(domainStore).domain) == null ? void 0 : _b.domain_name) || "Our Website")}</h1><div class="uc-divider" data-v-3d376feb></div><p class="uc-text" data-v-3d376feb>Our website is currently under construction.</p><p class="uc-subtext" data-v-3d376feb>We&#39;re working hard to bring you an amazing experience. Please check back soon!</p></div></div>`);
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "loading" }, _attrs))} data-v-3d376feb>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      }
    };
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3d376feb"]]);

export { index as default };
//# sourceMappingURL=index-xIMtD52V.mjs.map
