...
import { p as parseSmartDescription, _ as __nuxt_component_0 } from './tiptapFormat-VsmiBmjD.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tiptapDoc = computed(() => {
      ...
      return (smart == null ? void 0 : smart.format) === "tiptap" || (smart == null ? void 0 : smart.format) === "wrapped-tiptap" ? smart.tiptapDoc : null;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "block-editor-test" }, _attrs))} data-v-521c724c><h1 data-v-521c724c>BlockEditor Test Page</h1><p data-v-521c724c>This page is a developer tool to manually verify the new Tiptap-based BlockEditor works end-to-end.</p><section class="test-section" data-v-521c724c><h2 data-v-521c724c>Test 1: Empty input</h2>`);
      ...
      _push(`<pre data-v-521c724c>value: ${ssrInterpolate(JSON.stringify(empty.value, null, 2))}</pre></section><section class="test-section" data-v-521c724c><h2 data-v-521c724c>Test 2: Tiptap doc input (already in new format)</h2>`);
      _push(ssrRenderComponent(_component_BlockEditor, {
      ...
      _push(`<pre data-v-521c724c>value: ${ssrInterpolate(JSON.stringify(tiptapSample.value, null, 2))}</pre></section><section class="test-section" data-v-521c724c><h2 data-v-521c724c>Test 3: Legacy TinyMCE input (should show warning + convert on save)</h2>`);
      _push(ssrRenderComponent(_component_BlockEditor, {
      ...
      _push(`<pre data-v-521c724c>value: ${ssrInterpolate(JSON.stringify(legacySample.value, null, 2))}</pre></section><section class="test-section" data-v-521c724c><h2 data-v-521c724c>Test 4: Public site render \u2014 Tiptap</h2><div class="render-box" data-v-521c724c>`);
      if (tiptapDoc.value) {
        _push(ssrRenderComponent(_component_BlockRenderer, { doc: tiptapDoc.value }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div></section><section class="test-section" data-v-521c724c><h2 data-v-521c724c>Test 5: Public site render \u2014 Legacy</h2><div class="render-box" data-v-521c724c>`);
      if (((_a = legacySmart.value) == null ? void 0 : _a.format) === "tiptap") {
        _push(`<div class="legacy-warning" data-v-521c724c> (format detection says this is Tiptap, not legacy) </div>`);
      } else {
        _push(`<div class="article-content" data-v-521c724c>${(_a2 = ((_b = legacySmart.value) == null ? void 0 : _b.description) || "") != null ? _a2 : ""}</div>`);
      }
      _push(`</div></section><section class="test-section" data-v-521c724c><h2 data-v-521c724c>Save log</h2><ul data-v-521c724c><!--[-->`);
      ssrRenderList(saveLog.value, (entry, i) => {
        _push(`<li data-v-521c724c>${ssrInterpolate(entry)}</li>`);
      });
...
const blockEditorTest = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-521c724c"]]);

export { blockEditorTest as default };
//# sourceMappingURL=block-editor-test-DRzM_Ljk.mjs.map
