...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="main-content" data-v-85147542><div class="container" data-v-85147542>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-85147542>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`<p data-v-85147542>${ssrInterpolate(_ctx.$t("common.loading"))}</p></div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(featuredNews).length > 0) {
          _push(`<section class="section news-section" data-v-85147542>`);
          if (unref(paginatedNews).length > 0) {
            _push(`<div class="featured-grid" data-v-85147542><!--[-->`);
            ssrRenderList(unref(paginatedNews).slice(0, 2), (news) => {
              _push(`<a href="#" class="featured-card" data-v-85147542><div class="featured-card-img" data-v-85147542>`);
              if (news.photo) {
                _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-85147542>`);
              } else {
                _push(`<div class="img-placeholder" data-v-85147542><i class="pi pi-image" data-v-85147542></i></div>`);
              }
              _push(`</div><div class="featured-card-body" data-v-85147542><h4 class="media-heading" data-v-85147542><a href="#" data-v-85147542>${ssrInterpolate(news.title)}</a></h4>`);
              if (news.short_description) {
                _push(`<p class="featured-excerpt" data-v-85147542>${ssrInterpolate(news.short_description)}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<p class="date" data-v-85147542><i class="fa fa-clock-o" data-v-85147542></i> ${ssrInterpolate(formatDate(news.publish_date))}</p></div></a>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          ...
          if (unref(paginatedNews).length > 2) {
            _push(`<div class="news-media-list" data-v-85147542><!--[-->`);
            ssrRenderList(unref(paginatedNews).slice(2), (news, index2) => {
              _push(`<!--[--><div class="news-media-item" data-v-85147542><div class="media-left" data-v-85147542><a href="#" data-v-85147542>`);
              if (news.photo) {
                _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-85147542>`);
              } else {
                _push(`<div class="img-placeholder small" data-v-85147542><i class="pi pi-image" data-v-85147542></i></div>`);
              }
              _push(`</a></div><div class="media-body" data-v-85147542><h4 class="media-heading" data-v-85147542><a href="#" data-v-85147542>${ssrInterpolate(news.title)}</a></h4>`);
              if (news.short_description) {
                _push(`<p class="media-excerpt" data-v-85147542>${ssrInterpolate(news.short_description)}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<p class="date" data-v-85147542><i class="fa fa-clock-o" data-v-85147542></i> ${ssrInterpolate(formatDate(news.publish_date))}</p></div></div>`);
              if (index2 < unref(paginatedNews).slice(2).length - 1) {
                _push(`<hr class="news-separator" data-v-85147542>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(totalPages) > 1) {
            _push(`<div class="pagination-wrap" data-v-85147542><ul class="pagination-list" data-v-85147542><li class="${ssrRenderClass([{ disabled: unref(currentPage) === 1 }, "page-item"])}" data-v-85147542><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-85147542> \xAB </button></li><li class="${ssrRenderClass([{ disabled: unref(currentPage) === 1 }, "page-item"])}" data-v-85147542><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-85147542> \u2039 </button></li><!--[-->`);
            ssrRenderList(unref(visiblePages), (page) => {
              _push(`<li class="${ssrRenderClass([{ active: page === unref(currentPage) }, "page-item"])}" data-v-85147542><button class="page-link" data-v-85147542>${ssrInterpolate(page)}</button></li>`);
            });
            _push(`<!--]--><li class="${ssrRenderClass([{ disabled: unref(currentPage) === unref(totalPages) }, "page-item"])}" data-v-85147542><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-85147542> \u203A </button></li><li class="${ssrRenderClass([{ disabled: unref(currentPage) === unref(totalPages) }, "page-item"])}" data-v-85147542><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-85147542> \xBB </button></li></ul></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</section>`);
        ...
        ssrRenderList(__props.menuTree, (menuItem) => {
          ...
          if (menuItem.children && menuItem.children.length > 0 && menuItem.children.some((child) => getContentForMenuItem(child.item_id))) {
            _push(`<section class="section"${ssrRenderAttr("id", `section-${menuItem.item_id}`)} data-v-85147542><!--[-->`);
            ssrRenderList(menuItem.children, (child) => {
              _push(`<div${ssrRenderAttr("id", `section-${child.item_id}`)} class="sub-section" data-v-85147542>${ssrInterpolate("Content Type:" + getContentType(child.item_id))} `);
            ...
            if (getContentForMenuItem(menuItem.item_id)) {
              ...
              } else if (getContentType(menuItem.item_id) === unref(ContentType).PRODUCT) {
                _push(ssrRenderComponent(_component_ProductCatalog, {
                  "content-id": getContentForMenuItem(menuItem.item_id).content.content_id,
        ...
        if (__props.socialMedia.length > 0) {
          _push(`<section class="section social-section" data-v-85147542><div class="social-links-center" data-v-85147542><!--[-->`);
          ssrRenderList(__props.socialMedia, (social) => {
            _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon-link" data-v-85147542><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-85147542></i></a>`);
          });
          _push(`<!--]--></div></section>`);
        } else {
          _push(`<!---->`);
...
const ClassicMultiPage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-85147542"]]);
...
//# sourceMappingURL=index-C1HkXi82.mjs.map
