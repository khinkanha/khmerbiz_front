import { defineComponent, computed, resolveComponent, unref, mergeProps, ref, watch, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createVNode, useSSRContext } from 'vue';
...
import { _ as _export_sfc, l as useRoute, b as useRuntimeConfig, k as useI18n, n as navigateTo } from './server.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (unref(currentLanguage)) {
              _push2(`<img${ssrRenderAttr("src", `/flag/${flagMap(unref(currentLanguage).flag)}`)}${ssrRenderAttr("alt", unref(currentLanguage).lang_name)} class="flag-icon" data-v-42bd6d72${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(currentLanguage)) {
              _push2(`<span data-v-42bd6d72${_scopeId}>${ssrInterpolate((_a = unref(currentLanguage).lang_code) == null ? void 0 : _a.toUpperCase())}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<i class="pi pi-chevron-down" data-v-42bd6d72${_scopeId}></i>`);
          } else {
            return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-42bd6d72"]]);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c54d60bd"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isReady)) {
        ...
        _push(`<main class="main-content" data-v-502468ed>`);
        ...
        if (unref(showPlugin) && ((_a = unref(settings)) == null ? void 0 : _a.chat_script)) {
          _push(`<div data-v-502468ed>${(_a2 = unref(settings).chat_script) != null ? _a2 : ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-502468ed"]]);

export { _default as default };
//# sourceMappingURL=default-DDbHL5X0.mjs.map
