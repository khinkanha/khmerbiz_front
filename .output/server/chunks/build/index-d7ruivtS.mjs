...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderClass, ssrRenderComponent } from 'vue/server-renderer';
import { u as useSettingStore } from './setting-BiKB_nXG.mjs';
  ...
  setup(__props) {
    ...
    const templates = [
      ...
      },
      {
        ...
        name: "Site Designer",
        color: "#7c3aed",
        desc: "Drag & drop your own layout",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-43c2e6fe><form data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.websiteTitle"))}</label><input type="text"${ssrRenderAttr("value", unref(form).title)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("settings.websiteTitle"))} data-v-43c2e6fe></div><div class="row" data-v-43c2e6fe><div class="col-md-6" data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.backgroundImage"))}</label><input type="file" accept="image/*" class="form-control" data-v-43c2e6fe>`);
      if (unref(bgPreview)) {
        _push(`<div style="${ssrRenderStyle({ "margin-top": "5px" })}" data-v-43c2e6fe><img${ssrRenderAttr("src", unref(bgPreview))} style="${ssrRenderStyle({ "max-height": "80px" })}" data-v-43c2e6fe></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="col-md-6" data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.screenMode"))}</label><select class="form-control" data-v-43c2e6fe><option value="1" data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).s_mode) ? ssrLooseContain(unref(form).s_mode, "1") : ssrLooseEqual(unref(form).s_mode, "1")) ? " selected" : ""}>Full Screen</option><option value="2" data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).s_mode) ? ssrLooseContain(unref(form).s_mode, "2") : ssrLooseEqual(unref(form).s_mode, "2")) ? " selected" : ""}>Medium</option></select></div></div></div><div class="row" data-v-43c2e6fe><div class="col-md-6" data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>Footer (Normal Text / HTML Code)</label><textarea class="form-control" rows="3" placeholder="Website Footer" data-v-43c2e6fe>${ssrInterpolate(unref(form).footer)}</textarea></div></div><div class="col-md-6" data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.footerAlignment"))}</label><select class="form-control" data-v-43c2e6fe><option${ssrRenderAttr("value", 1)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).footer_align) ? ssrLooseContain(unref(form).footer_align, 1) : ssrLooseEqual(unref(form).footer_align, 1)) ? " selected" : ""}>Left</option><option${ssrRenderAttr("value", 2)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).footer_align) ? ssrLooseContain(unref(form).footer_align, 2) : ssrLooseEqual(unref(form).footer_align, 2)) ? " selected" : ""}>Center</option><option${ssrRenderAttr("value", 3)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).footer_align) ? ssrLooseContain(unref(form).footer_align, 3) : ssrLooseEqual(unref(form).footer_align, 3)) ? " selected" : ""}>Right</option></select></div></div></div><div class="row" data-v-43c2e6fe><div class="col-md-6" data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.themeStyle"))}</label><select class="form-control" data-v-43c2e6fe><option${ssrRenderAttr("value", 0)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).theme) ? ssrLooseContain(unref(form).theme, 0) : ssrLooseEqual(unref(form).theme, 0)) ? " selected" : ""}>Default</option><option${ssrRenderAttr("value", 1)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).theme) ? ssrLooseContain(unref(form).theme, 1) : ssrLooseEqual(unref(form).theme, 1)) ? " selected" : ""}>Dark</option><option${ssrRenderAttr("value", 2)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).theme) ? ssrLooseContain(unref(form).theme, 2) : ssrLooseEqual(unref(form).theme, 2)) ? " selected" : ""}>Red</option><option${ssrRenderAttr("value", 3)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).theme) ? ssrLooseContain(unref(form).theme, 3) : ssrLooseEqual(unref(form).theme, 3)) ? " selected" : ""}>Green</option><option${ssrRenderAttr("value", 4)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).theme) ? ssrLooseContain(unref(form).theme, 4) : ssrLooseEqual(unref(form).theme, 4)) ? " selected" : ""}>Purple</option><option${ssrRenderAttr("value", 5)} data-v-43c2e6fe${ssrIncludeBooleanAttr(Array.isArray(unref(form).theme) ? ssrLooseContain(unref(form).theme, 5) : ssrLooseEqual(unref(form).theme, 5)) ? " selected" : ""}>Yellow</option></select></div></div><div class="col-md-6" data-v-43c2e6fe><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.googleAnalytics"))}</label><input type="text"${ssrRenderAttr("value", unref(form).tracking_id)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("settings.googleAnalytics"))} data-v-43c2e6fe></div></div></div><div class="form-group" data-v-43c2e6fe><label data-v-43c2e6fe>${ssrInterpolate(_ctx.$t("settings.widgetChat"))}</label><textarea class="form-control" rows="3" placeholder="Widget Chat" data-v-43c2e6fe>${ssrInterpolate(unref(form).chat_script)}</textarea></div><div class="form-group" data-v-43c2e6fe><label class="tpl-label" data-v-43c2e6fe>Choose Template Style</label><div class="template-picker" data-v-43c2e6fe><!--[-->`);
      ssrRenderList(templates, (tpl) => {
        var _a;
        _push(`<div class="${ssrRenderClass([{ selected: unref(form).page_style == tpl.id }, "tpl-card"])}" data-v-43c2e6fe><div class="tpl-bar" style="${ssrRenderStyle({ background: tpl.color })}" data-v-43c2e6fe></div><div class="tpl-preview" data-v-43c2e6fe>${(_a = tpl.preview) != null ? _a : ""}</div><div class="tpl-meta" data-v-43c2e6fe><div class="tpl-name" data-v-43c2e6fe>${ssrInterpolate(tpl.name)}</div><div class="tpl-desc" data-v-43c2e6fe>${ssrInterpolate(tpl.desc)}</div></div><div class="tpl-chk" data-v-43c2e6fe><i class="fa fa-check" data-v-43c2e6fe></i></div></div>`);
      });
      _push(`<!--]--></div></div><div class="form-group designer-block" data-v-43c2e6fe><label class="tpl-label" data-v-43c2e6fe>Site Designer</label><div class="designer-row" data-v-43c2e6fe><span class="designer-help" data-v-43c2e6fe>Build a custom homepage with drag &amp; drop blocks, your own colors, header &amp; footer. When left empty, the homepage keeps showing the menu content from the template above.</span>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/admin/builder",
        class: "btn btn-primary designer-btn"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fa fa-paint-brush" data-v-43c2e6fe${_scopeId}></i> Open Designer `);
          } else {
            return [
              createVNode("i", { class: "fa fa-paint-brush" }),
              createTextVNode(" Open Designer ")
            ];
          }
        }),
        _: 1
      ...
      if (unref(successMessage)) {
        _push(`<div class="alert alert-success" data-v-43c2e6fe>${ssrInterpolate(unref(successMessage))}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(errorMessage)) {
        _push(`<div class="alert alert-danger" data-v-43c2e6fe>${ssrInterpolate(unref(errorMessage))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button type="submit" class="btn btn-danger"${ssrIncludeBooleanAttr(unref(saving)) ? " disabled" : ""} data-v-43c2e6fe><i class="fa fa-floppy-o" data-v-43c2e6fe></i> ${ssrInterpolate(_ctx.$t("settings.save"))}</button></form></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-43c2e6fe"]]);

export { index as default };
//# sourceMappingURL=index-d7ruivtS.mjs.map
