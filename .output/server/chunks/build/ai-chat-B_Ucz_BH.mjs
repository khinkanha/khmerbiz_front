...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { sendMessage, loading, error, messages, hasMessages, usageInfo, canSendMessage, isLimitReached, resetChat } = useAIChat();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ai-chat-container" }, _attrs))} data-v-ae8e3886><div class="chat-header" data-v-ae8e3886><div class="header-left" data-v-ae8e3886><h3 data-v-ae8e3886>AI Assistant</h3>`);
      if (unref(usageInfo)) {
      ...
      _push(`</div><div class="header-right" data-v-ae8e3886>`);
      ...
      _push(`</div></div><div class="messages-container" data-v-ae8e3886>`);
      if (!unref(hasMessages)) {
        _push(`<div class="empty-state" data-v-ae8e3886><i class="pi pi-android" style="${ssrRenderStyle({ "font-size": "3rem", "color": "#6366f1" })}" data-v-ae8e3886></i><h4 data-v-ae8e3886>Ask AI anything about your website</h4><div class="ai-capabilities" data-v-ae8e3886><div class="capability-group" data-v-ae8e3886><div class="capability-title" data-v-ae8e3886><i class="pi pi-bolt" data-v-ae8e3886></i> Quick Setup</div><ul class="suggestions" data-v-ae8e3886><li data-v-ae8e3886>&quot;Create a fresh website for my business&quot;</li><li data-v-ae8e3886>&quot;Apply a portfolio template to my site&quot;</li></ul></div><div class="capability-group" data-v-ae8e3886><div class="capability-title" data-v-ae8e3886><i class="pi pi-palette" data-v-ae8e3886></i> Themes &amp; Layout</div><ul class="suggestions" data-v-ae8e3886><li data-v-ae8e3886>&quot;Change my theme to purple&quot;</li><li data-v-ae8e3886>&quot;Switch to magazine layout&quot;</li><li data-v-ae8e3886>&quot;Move the logo to the left and menu to the top&quot;</li></ul></div><div class="capability-group" data-v-ae8e3886><div class="capability-title" data-v-ae8e3886><i class="pi pi-file" data-v-ae8e3886></i> Content &amp; Articles</div><ul class="suggestions" data-v-ae8e3886><li data-v-ae8e3886>&quot;Create a new article about our services&quot;</li><li data-v-ae8e3886>&quot;Update my home page content&quot;</li><li data-v-ae8e3886>&quot;Create a new page called Team&quot;</li></ul></div><div class="capability-group" data-v-ae8e3886><div class="capability-title" data-v-ae8e3886><i class="pi pi-bars" data-v-ae8e3886></i> Menu Management</div><ul class="suggestions" data-v-ae8e3886><li data-v-ae8e3886>&quot;Add a Services menu item&quot;</li><li data-v-ae8e3886>&quot;Reorder my menu items&quot;</li><li data-v-ae8e3886>&quot;Delete the Contact Us menu&quot;</li></ul></div><div class="capability-group" data-v-ae8e3886><div class="capability-title" data-v-ae8e3886><i class="pi pi-image" data-v-ae8e3886></i> Banners &amp; News</div><ul class="suggestions" data-v-ae8e3886><li data-v-ae8e3886>&quot;Create a news article about our latest product launch&quot;</li><li data-v-ae8e3886>&quot;Change the banner display style&quot;</li></ul></div><div class="capability-group" data-v-ae8e3886><div class="capability-title" data-v-ae8e3886><i class="pi pi-search" data-v-ae8e3886></i> SEO</div><ul class="suggestions" data-v-ae8e3886><li data-v-ae8e3886>&quot;Generate SEO keywords for my content&quot;</li><li data-v-ae8e3886>&quot;Update SEO metadata for my home page&quot;</li></ul></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(unref(messages), (message) => {
        _push(`<div class="${ssrRenderClass(["message", message.role])}" data-v-ae8e3886><div class="message-header" data-v-ae8e3886><span class="message-role" data-v-ae8e3886>${ssrInterpolate(message.role === "user" ? "You" : "AI Assistant")}</span><span class="message-time" data-v-ae8e3886>${ssrInterpolate(formatTime(message.timestamp))}</span></div><div class="message-content" data-v-ae8e3886>${ssrInterpolate(message.content)}</div>`);
        if (message.toolCalls && message.toolCalls.length > 0) {
          _push(`<div class="tool-calls" data-v-ae8e3886><div class="tool-calls-header" data-v-ae8e3886><i class="pi pi-cog" data-v-ae8e3886></i> Actions performed: </div><!--[-->`);
          ssrRenderList(message.toolCalls, (tool, index) => {
            _push(`<div class="${ssrRenderClass(["tool-call", tool.success ? "success" : "error"])}" data-v-ae8e3886><div class="tool-name" data-v-ae8e3886>${ssrInterpolate(formatToolName(tool.toolName))}</div>`);
            if (tool.success) {
              _push(`<div class="tool-result" data-v-ae8e3886>${ssrInterpolate(formatToolResult(tool))}</div>`);
            } else {
              _push(`<div class="tool-error" data-v-ae8e3886>${ssrInterpolate(tool.error)}</div>`);
            }
            _push(`</div>`);
          });
          _push(`<!--]--></div>`);
        ...
        if (message.loading) {
          _push(`<div class="message-loading" data-v-ae8e3886>`);
          _push(ssrRenderComponent(_component_ProgressSpinner, {
            style: { "width": "20px", "height": "20px" },
            strokeWidth: "4"
          }, null, _parent));
          _push(`<span data-v-ae8e3886>AI is thinking...</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="input-area" data-v-ae8e3886><div class="input-wrapper" data-v-ae8e3886>`);
      ...
      _push(`<div class="input-footer" data-v-ae8e3886><span class="input-hint" data-v-ae8e3886>Ctrl + Enter to send</span>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ae8e3886"]]);
...
//# sourceMappingURL=ai-chat-B_Ucz_BH.mjs.map
