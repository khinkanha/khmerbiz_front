...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content-list-page" }, _attrs))} data-v-4ce7c005><div class="page-header" data-v-4ce7c005><h1 class="page-title" data-v-4ce7c005>${ssrInterpolate(_ctx.$t("contentManager.title"))}</h1><div class="page-actions" data-v-4ce7c005>`);
      ...
      _push(ssrRenderComponent(_component_Card, { class: "filter-card" }, {
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="filter-row" data-v-4ce7c005${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="action-buttons" data-v-4ce7c005${_scopeId3}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4ce7c005"]]);

export { index as default };
//# sourceMappingURL=index-BZ-wqL_7.mjs.map
