...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const needsLogo = computed(() => {
      ...
      return !((_a = domainStore.settings) == null ? void 0 : _a.logo);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard" }, _attrs))} data-v-f3a2ce1b>`);
      if (unref(needsSetup)) {
        _push(`<div class="setup-banner" data-v-f3a2ce1b><div class="setup-banner-content" data-v-f3a2ce1b><div class="setup-banner-text" data-v-f3a2ce1b><i class="pi pi-exclamation-circle" data-v-f3a2ce1b></i><span data-v-f3a2ce1b>Your website isn&#39;t set up yet. Complete the Quick Setup to get started.</span></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Quick Setup <i class="pi pi-arrow-right" data-v-f3a2ce1b${_scopeId}></i>`);
            } else {
              return [
        ...
        _push(`</div></div>`);
      } else if (unref(needsLogo)) {
        _push(`<div class="setup-banner logo-banner" data-v-f3a2ce1b><div class="setup-banner-content" data-v-f3a2ce1b><div class="setup-banner-text" data-v-f3a2ce1b><i class="pi pi-image" data-v-f3a2ce1b></i><span data-v-f3a2ce1b>Your website doesn&#39;t have a logo yet. Upload one to make your site look professional.</span></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Upload Logo <i class="pi pi-arrow-right" data-v-f3a2ce1b${_scopeId}></i>`);
            } else {
              return [
                createTextVNode(" Upload Logo "),
                createVNode("i", { class: "pi pi-arrow-right" })
              ];
            }
          }),
      ...
      _push(`<div class="panel" data-v-f3a2ce1b><div class="panel-header" data-v-f3a2ce1b>${ssrInterpolate(_ctx.$t("dashboard.quickActions"))}</div><div class="panel-body" data-v-f3a2ce1b>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/admin/ai-chat",
        class: "qbtn-link"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="qbtn ai-chat-btn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u{1F916}</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard.AIAssitant"))}</div></div>`);
          } else {
            return [
              createVNode("div", { class: "qbtn ai-chat-btn" }, [
                createVNode("div", { class: "qbtn-icon" }, "\u{1F916}"),
                createVNode("div", { class: "qbtn-label" }, toDisplayString(_ctx.$t("dashboard.AIAssitant")), 1)
              ])
            ];
          }
        }),
      ...
      if (unref(authStore).user) {
        ...
        if (!unref(authStore).isSuperAdmin) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="qbtn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u2699\uFE0F</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard.settings"))}</div></div>`);
              } else {
                return [
        ...
        if (!unref(authStore).isSuperAdmin) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="qbtn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u{1F4DD}</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard.manageContent"))}</div></div>`);
              } else {
                return [
                  createVNode("div", { class: "qbtn" }, [
        ...
        if (!unref(authStore).isSuperAdmin) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="qbtn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u{1F5BC}\uFE0F</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard.uploadMedia"))}</div></div>`);
              } else {
                return [
                  createVNode("div", { class: "qbtn" }, [
        ...
        if (!unref(authStore).isSuperAdmin && !unref(authStore).isNormalUser) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="qbtn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u{1F465}</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard.userManagement"))}</div></div>`);
              } else {
                return [
                  createVNode("div", { class: "qbtn" }, [
        ...
        if (unref(authStore).isSuperAdmin) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="qbtn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u{1F310}</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("sidebar.domains"))}</div></div>`);
              } else {
                return [
                  createVNode("div", { class: "qbtn" }, [
        ...
        if (unref(authStore).isSuperAdmin) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="qbtn" data-v-f3a2ce1b${_scopeId}><div class="qbtn-icon" data-v-f3a2ce1b${_scopeId}>\u{1F4E2}</div><div class="qbtn-label" data-v-f3a2ce1b${_scopeId}>${ssrInterpolate(_ctx.$t("sidebar.announce"))}</div></div>`);
              } else {
                return [
                  createVNode("div", { class: "qbtn" }, [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f3a2ce1b"]]);

export { index as default };
//# sourceMappingURL=index-BREBbFLM.mjs.map
