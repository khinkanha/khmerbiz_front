...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "news-page" }, _attrs))} data-v-c0bb3f1c><div class="page-header" data-v-c0bb3f1c><h1 class="page-title" data-v-c0bb3f1c>${ssrInterpolate(_ctx.$t("contentManager.blogNews"))}: ${ssrInterpolate((_a = unref(contentStore).currentContent) == null ? void 0 : _a.title)}</h1><div class="page-actions" data-v-c0bb3f1c>`);
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data.photo) {
                          _push4(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${data.photo}`)}${ssrRenderAttr("alt", data.title)} class="news-thumb" data-v-c0bb3f1c${_scopeId3}>`);
                        } else {
                          _push4(`<span data-v-c0bb3f1c${_scopeId3}>-</span>`);
                        }
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="action-buttons" data-v-c0bb3f1c${_scopeId3}>`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="news-form" data-v-c0bb3f1c${_scopeId}><div class="form-group" data-v-c0bb3f1c${_scopeId}><label for="newsTitle" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.contentTitle"))} *</label>`);
            ...
            if (unref(newsErrors).title) {
              _push2(`<small class="p-error" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(unref(newsErrors).title)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-c0bb3f1c${_scopeId}><label for="shortDescription" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.shortDescription"))} *</label>`);
            ...
            if (unref(newsErrors).short_description) {
              _push2(`<small class="p-error" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(unref(newsErrors).short_description)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-c0bb3f1c${_scopeId}><label for="description" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.description"))} *</label>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
            if (unref(newsErrors).description) {
              _push2(`<small class="p-error" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(unref(newsErrors).description)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-c0bb3f1c${_scopeId}><label for="newsPhoto" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.primaryImage"))}</label>`);
            ...
            if (unref(newsForm).photoPreview) {
              _push2(`<div class="photo-preview" data-v-c0bb3f1c${_scopeId}><img${ssrRenderAttr("src", unref(newsForm).photoPreview)} alt="Preview" data-v-c0bb3f1c${_scopeId}>`);
            ...
            _push2(`</div><div class="form-group" data-v-c0bb3f1c${_scopeId}><label for="publishDate" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.publishDate"))}</label>`);
            ...
            _push2(`</div><div class="form-group" data-v-c0bb3f1c${_scopeId}><label for="newsStatus" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.status") || "Status")}</label><div class="status-toggle" data-v-c0bb3f1c${_scopeId}>`);
            ...
            _push2(`<span class="status-label" data-v-c0bb3f1c${_scopeId}>${ssrInterpolate(unref(newsForm).status ? _ctx.$t("contentManager.show") || "Show" : _ctx.$t("contentManager.notShow") || "Not Show")}</span></div></div><div class="form-actions" data-v-c0bb3f1c${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Button, {
              type: "button",
...
const news = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c0bb3f1c"]]);

export { news as default };
//# sourceMappingURL=news-DwFFLHsH.mjs.map
