...
import { _ as _export_sfc, k as useConfirm, l as useI18n, u as useRouter, m as useRoute, b as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "news-page" }, _attrs))} data-v-4d5963a8><div class="page-header" data-v-4d5963a8><h1 class="page-title" data-v-4d5963a8>${ssrInterpolate(_ctx.$t("contentManager.blogNews"))}: ${ssrInterpolate((_a = unref(contentStore).currentContent) == null ? void 0 : _a.title)}</h1><div class="page-actions" data-v-4d5963a8>`);
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data.photo) {
                          _push4(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${data.photo}`)}${ssrRenderAttr("alt", data.title)} class="news-thumb" data-v-4d5963a8${_scopeId3}>`);
                        } else {
                          _push4(`<span data-v-4d5963a8${_scopeId3}>-</span>`);
                        }
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="action-buttons" data-v-4d5963a8${_scopeId3}>`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="news-form" data-v-4d5963a8${_scopeId}><div class="form-group" data-v-4d5963a8${_scopeId}><label for="newsTitle" data-v-4d5963a8${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.contentTitle"))} *</label>`);
            ...
            if (unref(newsErrors).title) {
              _push2(`<small class="p-error" data-v-4d5963a8${_scopeId}>${ssrInterpolate(unref(newsErrors).title)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-4d5963a8${_scopeId}><label for="shortDescription" data-v-4d5963a8${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.shortDescription"))} *</label>`);
            ...
            if (unref(newsErrors).short_description) {
              _push2(`<small class="p-error" data-v-4d5963a8${_scopeId}>${ssrInterpolate(unref(newsErrors).short_description)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-4d5963a8${_scopeId}><label for="description" data-v-4d5963a8${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.description"))} *</label>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
            if (unref(newsErrors).description) {
              _push2(`<small class="p-error" data-v-4d5963a8${_scopeId}>${ssrInterpolate(unref(newsErrors).description)}</small>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-group" data-v-4d5963a8${_scopeId}><label for="newsPhoto" data-v-4d5963a8${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.primaryImage"))}</label>`);
            ...
            if (unref(newsForm).photoPreview) {
              _push2(`<div class="photo-preview" data-v-4d5963a8${_scopeId}><img${ssrRenderAttr("src", unref(newsForm).photoPreview)} alt="Preview" data-v-4d5963a8${_scopeId}>`);
            ...
            _push2(`</div><div class="form-group" data-v-4d5963a8${_scopeId}><label for="publishDate" data-v-4d5963a8${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.publishDate"))}</label>`);
            ...
            _push2(`</div><div class="form-group" data-v-4d5963a8${_scopeId}><label for="newsStatus" data-v-4d5963a8${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.status") || "Status")}</label><div class="status-toggle" data-v-4d5963a8${_scopeId}>`);
            ...
            _push2(`<span class="status-label" data-v-4d5963a8${_scopeId}>${ssrInterpolate(unref(newsForm).status ? _ctx.$t("contentManager.show") || "Show" : _ctx.$t("contentManager.notShow") || "Not Show")}</span></div></div><div class="form-actions" data-v-4d5963a8${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Button, {
              type: "button",
...
const news = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4d5963a8"]]);

export { news as default };
//# sourceMappingURL=news-Cywd0ulV.mjs.map
