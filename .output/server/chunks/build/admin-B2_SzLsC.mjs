...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-layout" }, _attrs))} data-v-1e90da9b>`);
      _push(ssrRenderComponent(_component_Toast, null, null, _parent));
      _push(`<div class="container text-right admin-logo-bar" data-v-1e90da9b><img${ssrRenderAttr("src", _imports_0)} alt="Logo" data-v-1e90da9b></div>`);
      ...
      _push(`<main class="main-content container" data-v-1e90da9b>`);
...
const admin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e90da9b"]]);

export { admin as default };
//# sourceMappingURL=admin-B2_SzLsC.mjs.map
