import { _ as __nuxt_component_0, a as __nuxt_component_1, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5, f as __nuxt_component_6 } from './ArticleSection-DKsoq-Ne.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-content" }, _attrs))} data-v-b07aa9da><div class="container" data-v-b07aa9da>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-b07aa9da>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`<p data-v-b07aa9da>${ssrInterpolate(_ctx.$t("common.loading"))}</p></div>`);
      } else if (unref(contentSection)) {
        _push(`<section class="section" data-v-b07aa9da>`);
        ...
        _push(`<div class="empty-state" data-v-b07aa9da><p data-v-b07aa9da>${ssrInterpolate(_ctx.$t("common.noContent") || "No content available")}</p></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const _menuId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b07aa9da"]]);

export { _menuId_ as default };
//# sourceMappingURL=_menuId_-B8T_2y-D.mjs.map
