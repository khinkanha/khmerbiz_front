...
import { _ as __nuxt_component_0$1, a as __nuxt_component_1$1, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5, f as _sfc_main$5 } from './ArticleSection-CkZe_zP5.mjs';
...
import { _ as __nuxt_component_0 } from './ContentRenderer-CJP1p8jO.mjs';
import { u as useHead } from './index-CrXeyONu.mjs';
import './tiptapFormat-VsmiBmjD.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ArticleSection = _sfc_main$5;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["classic-multi-page", unref(containerClass)]
      }, _attrs))} data-v-ec3350f8>`);
      ...
      _push(`<main class="main-content" data-v-ec3350f8><div class="container" data-v-ec3350f8>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-ec3350f8>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`<p data-v-ec3350f8>${ssrInterpolate(_ctx.$t("common.loading"))}</p></div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(featuredNews).length > 0) {
          _push(`<section class="section news-section" data-v-ec3350f8>`);
          if (unref(paginatedNews).length > 0) {
            _push(`<div class="featured-grid" data-v-ec3350f8><!--[-->`);
            ssrRenderList(unref(paginatedNews).slice(0, 2), (news) => {
              _push(`<a href="#" class="featured-card" data-v-ec3350f8><div class="featured-card-img" data-v-ec3350f8>`);
              if (news.photo) {
                _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-ec3350f8>`);
              } else {
                _push(`<div class="img-placeholder" data-v-ec3350f8><i class="pi pi-image" data-v-ec3350f8></i></div>`);
              }
              _push(`</div><div class="featured-card-body" data-v-ec3350f8><h4 class="media-heading" data-v-ec3350f8><a href="#" data-v-ec3350f8>${ssrInterpolate(news.title)}</a></h4>`);
              if (news.short_description) {
                _push(`<p class="featured-excerpt" data-v-ec3350f8>${ssrInterpolate(news.short_description)}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<p class="date" data-v-ec3350f8><i class="fa fa-clock-o" data-v-ec3350f8></i> ${ssrInterpolate(formatDate(news.publish_date))}</p></div></a>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          ...
          if (unref(paginatedNews).length > 2) {
            _push(`<div class="news-media-list" data-v-ec3350f8><!--[-->`);
            ssrRenderList(unref(paginatedNews).slice(2), (news, index2) => {
              _push(`<!--[--><div class="news-media-item" data-v-ec3350f8><div class="media-left" data-v-ec3350f8><a href="#" data-v-ec3350f8>`);
              if (news.photo) {
                _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-ec3350f8>`);
              } else {
                _push(`<div class="img-placeholder small" data-v-ec3350f8><i class="pi pi-image" data-v-ec3350f8></i></div>`);
              }
              _push(`</a></div><div class="media-body" data-v-ec3350f8><h4 class="media-heading" data-v-ec3350f8><a href="#" data-v-ec3350f8>${ssrInterpolate(news.title)}</a></h4>`);
              if (news.short_description) {
                _push(`<p class="media-excerpt" data-v-ec3350f8>${ssrInterpolate(news.short_description)}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<p class="date" data-v-ec3350f8><i class="fa fa-clock-o" data-v-ec3350f8></i> ${ssrInterpolate(formatDate(news.publish_date))}</p></div></div>`);
              if (index2 < unref(paginatedNews).slice(2).length - 1) {
                _push(`<hr class="news-separator" data-v-ec3350f8>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(totalPages) > 1) {
            _push(`<div class="pagination-wrap" data-v-ec3350f8><ul class="pagination-list" data-v-ec3350f8><li class="${ssrRenderClass([{ disabled: unref(currentPage) === 1 }, "page-item"])}" data-v-ec3350f8><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-ec3350f8> \xAB </button></li><li class="${ssrRenderClass([{ disabled: unref(currentPage) === 1 }, "page-item"])}" data-v-ec3350f8><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-ec3350f8> \u2039 </button></li><!--[-->`);
            ssrRenderList(unref(visiblePages), (page) => {
              _push(`<li class="${ssrRenderClass([{ active: page === unref(currentPage) }, "page-item"])}" data-v-ec3350f8><button class="page-link" data-v-ec3350f8>${ssrInterpolate(page)}</button></li>`);
            });
            _push(`<!--]--><li class="${ssrRenderClass([{ disabled: unref(currentPage) === unref(totalPages) }, "page-item"])}" data-v-ec3350f8><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-ec3350f8> \u203A </button></li><li class="${ssrRenderClass([{ disabled: unref(currentPage) === unref(totalPages) }, "page-item"])}" data-v-ec3350f8><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-ec3350f8> \xBB </button></li></ul></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</section>`);
        ...
        if (__props.menuTree[0].children && __props.menuTree[0].children.length > 0) {
          _push(`<section data-v-ec3350f8><!--[-->`);
          ssrRenderList(__props.menuTree[0].children, (child) => {
            _push(`<div${ssrRenderAttr("id", `section-${child.item_id}`)} class="sub-section" data-v-ec3350f8>`);
          ...
          _push(`<section class="section"${ssrRenderAttr("id", `section-${__props.menuTree[0].item_id}`)} data-v-ec3350f8>`);
        ...
        if (__props.socialMedia.length > 0) {
          _push(`<section class="section social-section" data-v-ec3350f8><div class="social-links-center" data-v-ec3350f8><!--[-->`);
          ssrRenderList(__props.socialMedia, (social) => {
            _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon-link" data-v-ec3350f8><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-ec3350f8></i></a>`);
          });
          _push(`<!--]--></div></section>`);
        } else {
          _push(`<!---->`);
...
const ClassicMultiPage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-ec3350f8"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showUnderConstruction)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "under-construction" }, _attrs))} data-v-4964900d><div class="uc-content" data-v-4964900d><div class="uc-icon" data-v-4964900d><i class="pi pi-building" data-v-4964900d></i></div><h1 class="uc-title" data-v-4964900d>${ssrInterpolate(((_a = unref(domainStore).settings) == null ? void 0 : _a.title) || ((_b = unref(domainStore).domain) == null ? void 0 : _b.domain_name) || "Our Website")}</h1><div class="uc-divider" data-v-4964900d></div><p class="uc-text" data-v-4964900d>Our website is currently under construction.</p><p class="uc-subtext" data-v-4964900d>We&#39;re working hard to bring you an amazing experience. Please check back soon!</p></div></div>`);
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "loading" }, _attrs))} data-v-4964900d>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      }
    };
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4964900d"]]);

export { index as default };
//# sourceMappingURL=index-8VYNynWj.mjs.map
