...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-ca426d2b><div class="flag" data-v-ca426d2b>`);
      _push(ssrRenderComponent(_component_LanguageSelector, null, null, _parent));
      _push(`</div>`);
      if (unref(logoPos) !== 3) {
        _push(`<div class="top-bar" data-v-ca426d2b><div class="container top-bar-inner" data-v-ca426d2b><div class="brand" data-v-ca426d2b>`);
        if ((_a = unref(settings)) == null ? void 0 : _a.logo) {
          _push(`<!--[--><img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_b = unref(settings)) == null ? void 0 : _b.title) || "Logo")} class="brand-logo desktop-logo" data-v-ca426d2b>`);
          if ((_c = unref(settings)) == null ? void 0 : _c.mobile_logo) {
            _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_d = unref(settings)) == null ? void 0 : _d.title) || "Logo")} class="brand-logo mobile-logo" data-v-ca426d2b>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
      ...
      _push(`<div class="mobile-logo-bar" data-v-ca426d2b><div class="container mobile-logo-inner" data-v-ca426d2b>`);
      if ((_e = unref(settings)) == null ? void 0 : _e.mobile_logo) {
        _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_f = unref(settings)) == null ? void 0 : _f.title) || "Logo")} class="mobile-logo-img" data-v-ca426d2b>`);
      } else if ((_g = unref(settings)) == null ? void 0 : _g.title) {
        _push(`<div class="mobile-logo-title" data-v-ca426d2b><h1 data-v-ca426d2b>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><nav class="navbar" data-v-ca426d2b><div class="container navbar-container" data-v-ca426d2b><div class="navbar-brand-group" data-v-ca426d2b><div class="mobile-brand" data-v-ca426d2b>`);
      if ((_h = unref(settings)) == null ? void 0 : _h.title) {
        _push(`<div class="brand-title" data-v-ca426d2b><h1 data-v-ca426d2b>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      ...
      _push(`<button class="navbar-toggler" type="button" aria-label="Toggle navigation" data-v-ca426d2b><i class="${ssrRenderClass(unref(mobileMenuOpen) ? "pi pi-times" : "pi pi-bars")}" data-v-ca426d2b></i></button></div><div class="${ssrRenderClass([unref(navMenuClass), "navbar-menu"])}" data-v-ca426d2b><ul class="${ssrRenderClass([unref(menuAlignClass), "navbar-nav"])}" data-v-ca426d2b><!--[-->`);
      ssrRenderList(unref(filteredMenuTree), (item) => {
        var _a2;
        _push(`<li class="${ssrRenderClass([{ dropdown: item.children && item.children.length > 0, "show-dropdown": unref(expandedMenuId) === item.item_id }, "nav-item"])}" data-v-ca426d2b>`);
        if (item.children && item.children.length > 0) {
          _push(`<!--[-->`);
          if (unref(isSinglePage)) {
            _push(`<a${ssrRenderAttr("href", `#section-${item.item_id}`)} class="${ssrRenderClass([{ active: unref(activeMenuId) === item.item_id }, "nav-link"])}" data-v-ca426d2b>${ssrInterpolate(item.item_name)}</a>`);
          } else {
            _push(`<a href="#" class="${ssrRenderClass([{ active: isMenuActive(item) }, "nav-link dropdown-toggle"])}" data-v-ca426d2b>${ssrInterpolate(item.item_name)} <i class="${ssrRenderClass([unref(expandedMenuId) === item.item_id ? "pi-chevron-up" : "pi-chevron-down", "pi toggle-icon"])}" data-v-ca426d2b></i></a>`);
          }
          _push(`<ul class="dropdown-menu" data-v-ca426d2b><!--[-->`);
          ssrRenderList(item.children, (child) => {
            var _a3;
            _push(`<li data-v-ca426d2b>`);
            if (unref(isSinglePage)) {
              _push(`<a class="dropdown-item"${ssrRenderAttr("href", `#section-${child.item_id}`)} data-v-ca426d2b>${ssrInterpolate(child.item_name)}</a>`);
            } else {
              _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      if (unref(logoPos) === 3) {
        _push(`<div class="top-bar bottom-bar" data-v-ca426d2b><div class="container top-bar-inner" data-v-ca426d2b><div class="brand" data-v-ca426d2b>`);
        if ((_i = unref(settings)) == null ? void 0 : _i.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_j = unref(settings)) == null ? void 0 : _j.title) || "Logo")} class="brand-logo" data-v-ca426d2b>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ca426d2b"]]);
...
//# sourceMappingURL=default-CZ7aATW_.mjs.map
