...
import { ssrRenderAttrs, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle, ssrRenderAttr, ssrRenderList } from 'vue/server-renderer';
import { u as useSettingStore } from './setting-CcHI0pzm.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="row"><div class="col-md-4"><form><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.slidePosition"))}</label><select class="form-control"><option value="1"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsForm).banner_pos) ? ssrLooseContain(unref(settingsForm).banner_pos, "1") : ssrLooseEqual(unref(settingsForm).banner_pos, "1")) ? " selected" : ""}>Top</option><option value="2"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsForm).banner_pos) ? ssrLooseContain(unref(settingsForm).banner_pos, "2") : ssrLooseEqual(unref(settingsForm).banner_pos, "2")) ? " selected" : ""}>Middle</option><option value="3"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsForm).banner_pos) ? ssrLooseContain(unref(settingsForm).banner_pos, "3") : ssrLooseEqual(unref(settingsForm).banner_pos, "3")) ? " selected" : ""}>Bottom</option></select></div><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.slideMode"))}</label><select class="form-control"><option value="1"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsForm).banner_mode) ? ssrLooseContain(unref(settingsForm).banner_mode, "1") : ssrLooseEqual(unref(settingsForm).banner_mode, "1")) ? " selected" : ""}>On</option><option value="0"${ssrIncludeBooleanAttr(Array.isArray(unref(settingsForm).banner_mode) ? ssrLooseContain(unref(settingsForm).banner_mode, "0") : ssrLooseEqual(unref(settingsForm).banner_mode, "0")) ? " selected" : ""}>Off</option></select></div><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.slideDisplay"))}</label><div><label style="${ssrRenderStyle({ "font-weight": "normal" })}"><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(settingsForm).banner_display, "0")) ? " checked" : ""} value="0"> Default Page</label><label style="${ssrRenderStyle({ "font-weight": "normal", "margin-left": "15px" })}"><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(unref(settingsForm).banner_display, "1")) ? " checked" : ""} value="1"> All Pages</label></div></div><button type="submit" class="btn btn-danger"${ssrIncludeBooleanAttr(unref(savingSettings)) ? " disabled" : ""}><i class="fa fa-floppy-o"></i> ${ssrInterpolate(_ctx.$t("settings.save"))}</button></form></div><div class="col-md-8"><div class="text-right" style="${ssrRenderStyle({ "margin-bottom": "10px" })}"><a href="#" class="btn btn-success"><i class="fa fa-plus"></i></a></div>`);
      if (unref(showAdd)) {
        _push(`<div class="panel panel-info" style="${ssrRenderStyle({ "margin-bottom": "15px" })}"><div class="panel-heading">${ssrInterpolate(_ctx.$t("settings.addImage"))}</div><div class="panel-body"><form><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.imageTitle"))}</label><input type="text"${ssrRenderAttr("value", unref(bannerForm).title)} class="form-control"></div><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.imageLink"))}</label><input type="text"${ssrRenderAttr("value", unref(bannerForm).link)} class="form-control" placeholder="https://..."></div><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.imageSize"))}</label><input type="file" accept="image/*" class="form-control">`);
      ...
      _push(`<div class="table-responsive"><table class="table table-striped table-hover"><thead><tr><th>#</th><th>Image</th><th>${ssrInterpolate(_ctx.$t("settings.imageTitle"))}</th><th>${ssrInterpolate(_ctx.$t("settings.imageLink"))}</th><th></th></tr></thead><tbody><!--[-->`);
      ssrRenderList(unref(settingStore).banners, (banner, i) => {
        _push(`<tr><td>${ssrInterpolate(i + 1)}</td><td>`);
        if (banner.photo) {
          _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${banner.photo}`)} style="${ssrRenderStyle({ "height": "50px", "border-radius": "4px" })}">`);
        } else {
          _push(`<!---->`);
        }
        _push(`</td><td>${ssrInterpolate(banner.title)}</td><td>${ssrInterpolate(banner.link)}</td><td><a href="#" class="text-danger"><i class="fa fa-trash-o fa-lg"></i></a></td></tr>`);
      });
...
//# sourceMappingURL=banner-Je_NqWGm.mjs.map
