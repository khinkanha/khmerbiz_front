...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form><div class="row"><div class="col-md-6"><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.menuPosition"))}</label><select class="form-control"><option value="1"${ssrIncludeBooleanAttr(Array.isArray(unref(form).menu_pos) ? ssrLooseContain(unref(form).menu_pos, "1") : ssrLooseEqual(unref(form).menu_pos, "1")) ? " selected" : ""}>Top</option><option value="2"${ssrIncludeBooleanAttr(Array.isArray(unref(form).menu_pos) ? ssrLooseContain(unref(form).menu_pos, "2") : ssrLooseEqual(unref(form).menu_pos, "2")) ? " selected" : ""}>Middle</option><option value="3"${ssrIncludeBooleanAttr(Array.isArray(unref(form).menu_pos) ? ssrLooseContain(unref(form).menu_pos, "3") : ssrLooseEqual(unref(form).menu_pos, "3")) ? " selected" : ""}>Bottom</option></select></div></div><div class="col-md-6"><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.menuAlignment"))}</label><select class="form-control"><option value="1"${ssrIncludeBooleanAttr(Array.isArray(unref(form).menu_align) ? ssrLooseContain(unref(form).menu_align, "1") : ssrLooseEqual(unref(form).menu_align, "1")) ? " selected" : ""}>Left</option><option value="2"${ssrIncludeBooleanAttr(Array.isArray(unref(form).menu_align) ? ssrLooseContain(unref(form).menu_align, "2") : ssrLooseEqual(unref(form).menu_align, "2")) ? " selected" : ""}>Center</option><option value="3"${ssrIncludeBooleanAttr(Array.isArray(unref(form).menu_align) ? ssrLooseContain(unref(form).menu_align, "3") : ssrLooseEqual(unref(form).menu_align, "3")) ? " selected" : ""}>Right</option></select></div></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/settings/menu.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=menu-SpPHlE4G.mjs.map
