...
import { defineComponent, computed, watch, resolveComponent, mergeProps, ref, unref, withCtx, createTextVNode, toDisplayString, createVNode, provide, useSSRContext } from 'vue';
...
import { u as useSeo } from './useSeo-YHq_XVB4.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar navbar-inverse title" }, _attrs))} data-v-c1b44c59><div class="container" data-v-c1b44c59><div class="navbar-header" data-v-c1b44c59><button type="button" class="navbar-toggle" data-v-c1b44c59><span class="icon-bar" data-v-c1b44c59></span><span class="icon-bar" data-v-c1b44c59></span><span class="icon-bar" data-v-c1b44c59></span></button><a class="navbar-brand hidden-lg hidden-md" href="#" data-v-c1b44c59>Cambodia Webhosting</a></div><div class="${ssrRenderClass([{ in: unref(mobileOpen) }, "navbar-collapse"])}" id="mybar" data-v-c1b44c59>`);
      if (unref(authStore).user) {
        _push(`<ul class="nav navbar-nav" data-v-c1b44c59><li class="${ssrRenderClass({ active: unref(currentTab) === "home" })}" data-v-c1b44c59>`);
        ...
        _push(`</li>`);
        if (unref(needsSetup)) {
          _push(`<li class="${ssrRenderClass({ active: unref(currentTab) === "setup" })}" data-v-c1b44c59>`);
          _push(ssrRenderComponent(_component_NuxtLink, { to: "/admin/setup" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<i class="fa fa-bolt" style="${ssrRenderStyle({ "margin-right": "4px" })}" data-v-c1b44c59${_scopeId}></i> Quick Setup`);
              } else {
                return [
                  createVNode("i", {
                    class: "fa fa-bolt",
        ...
        if (unref(authStore).isSuperAdmin) {
          _push(`<li class="${ssrRenderClass({ active: unref(currentTab) === "admin", dropdown: true })}" data-v-c1b44c59><a class="dropdown-toggle" data-v-c1b44c59>${ssrInterpolate(_ctx.$t("sidebar.admin"))} <b class="caret" data-v-c1b44c59></b></a>`);
          if (unref(adminDrop)) {
            _push(`<ul class="dropdown-menu" data-v-c1b44c59><li data-v-c1b44c59>`);
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<i class="fa fa-users" data-v-c1b44c59${_scopeId}></i> ${ssrInterpolate(_ctx.$t("sidebar.users"))}`);
                } else {
                  return [
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<i class="fa fa-globe" data-v-c1b44c59${_scopeId}></i> ${ssrInterpolate(_ctx.$t("userManager.domain"))}`);
                } else {
                  return [
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<i class="fa fa-bullhorn" data-v-c1b44c59${_scopeId}></i> ${ssrInterpolate(_ctx.$t("sidebar.announce"))}`);
                } else {
                  return [
        ...
        if (unref(authStore).isWebAdmin || !unref(authStore).isSuperAdmin && unref(hasDomain) && !unref(isSitebuilder)) {
          _push(`<!--[--><li class="${ssrRenderClass({ active: unref(currentTab) === "websetting" })}" data-v-c1b44c59>`);
          ...
          _push(`</li><li class="${ssrRenderClass({ active: unref(currentTab) === "menu" })}" data-v-c1b44c59>`);
          ...
          _push(`</li><li class="${ssrRenderClass({ active: unref(currentTab) === "content" })}" data-v-c1b44c59>`);
        ...
        if (unref(authStore).isWebAdmin || unref(hasDomain)) {
          _push(`<li class="${ssrRenderClass({ active: unref(currentTab) === "media" })}" data-v-c1b44c59>`);
        ...
        if (!unref(authStore).isNormalUser) {
          _push(`<li class="${ssrRenderClass({ active: unref(currentTab) === "member" })}" data-v-c1b44c59>`);
      ...
      _push(`<ul class="nav navbar-nav navbar-right" data-v-c1b44c59>`);
      if (!unref(authStore).isAuthenticated) {
        _push(`<li data-v-c1b44c59>`);
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/member/login" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`<li class="dropdown user-dropdown" data-v-c1b44c59><a class="dropdown-toggle" data-v-c1b44c59><i class="fa fa-user" data-v-c1b44c59></i> ${ssrInterpolate(unref(userName))} <b class="caret" data-v-c1b44c59></b></a>`);
        if (unref(userDrop)) {
          _push(`<ul class="dropdown-menu" data-v-c1b44c59><li data-v-c1b44c59>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/admin/profile",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<i class="fa fa-user" data-v-c1b44c59${_scopeId}></i> ${ssrInterpolate(_ctx.$t("userManager.profileSetting"))}`);
              } else {
                return [
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<i class="fa fa-gear" data-v-c1b44c59${_scopeId}></i> ${ssrInterpolate(_ctx.$t("userManager.passwordSetting"))}`);
              } else {
                return [
          ...
          _push(`</li><li class="divider" data-v-c1b44c59></li><li data-v-c1b44c59><a href="#" data-v-c1b44c59><i class="fa fa-power-off" data-v-c1b44c59></i> ${ssrInterpolate(_ctx.$t("sidebar.logout"))}</a></li></ul>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</li>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c1b44c59"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-footer" }, _attrs))} data-v-fab39811><div class="container text-center" data-v-fab39811><p data-v-fab39811> KHMER.BIZ | <a href="/docs/USER_GUIDE.html" target="_blank" data-v-fab39811><i class="fa fa-book-open-reader fa-lg" data-v-fab39811></i> User Guide </a> | <a href="https://t.me/cambodiawebhosting" target="_blank" data-v-fab39811><i class="fa-brands fa-telegram fa-lg" data-v-fab39811></i> cambodiawebhosting </a> | <a href="https://www.youtube.com/@cambodiawebhosting" target="_blank" data-v-fab39811><i class="fa-brands fa-youtube text-danger fa-lg" data-v-fab39811></i> Cambodia Web Hosting </a></p></div></div>`);
}
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fab39811"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "admin-layout" }, _attrs))} data-v-7a65b7f0>`);
      _push(ssrRenderComponent(_component_Toast, null, null, _parent));
      _push(`<div class="container text-right admin-logo-bar" data-v-7a65b7f0><img${ssrRenderAttr("src", _imports_0)} alt="Logo" data-v-7a65b7f0></div>`);
      ...
      _push(`<main class="main-content container" data-v-7a65b7f0>`);
...
const admin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7a65b7f0"]]);

export { admin as default };
//# sourceMappingURL=admin-Cl4M-0Ue.mjs.map
