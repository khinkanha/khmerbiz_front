...
import { _ as __nuxt_component_0 } from './ContentRenderer-CuRfUW_E.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showUnderConstruction)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "under-construction" }, _attrs))} data-v-50d91f21><div class="uc-content" data-v-50d91f21><div class="uc-icon" data-v-50d91f21><i class="pi pi-building" data-v-50d91f21></i></div><h1 class="uc-title" data-v-50d91f21>${ssrInterpolate(((_a = unref(domainStore).settings) == null ? void 0 : _a.title) || ((_b = unref(domainStore).domain) == null ? void 0 : _b.domain_name) || "Our Website")}</h1><div class="uc-divider" data-v-50d91f21></div><p class="uc-text" data-v-50d91f21>Our website is currently under construction.</p><p class="uc-subtext" data-v-50d91f21>We&#39;re working hard to bring you an amazing experience. Please check back soon!</p></div></div>`);
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "loading" }, _attrs))} data-v-50d91f21>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      }
    };
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-50d91f21"]]);

export { index as default };
//# sourceMappingURL=index-oPN9Xl0t.mjs.map
