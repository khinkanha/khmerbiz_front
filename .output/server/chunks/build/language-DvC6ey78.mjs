...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><form><div class="row"><div class="col-md-6"><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.languageTitle"))}</label><input type="text"${ssrRenderAttr("value", unref(langForm).lang_name)} class="form-control"${ssrRenderAttr("placeholder", _ctx.$t("settings.languageTitle"))}></div></div><div class="col-md-6"><div class="form-group"><label>${ssrInterpolate(_ctx.$t("settings.flagType"))}</label><select class="form-control"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(langForm).flag_icon) ? ssrLooseContain(unref(langForm).flag_icon, "") : ssrLooseEqual(unref(langForm).flag_icon, "")) ? " selected" : ""}>-- Select --</option><!--[-->`);
      ssrRenderList(flagOptions, (f) => {
        _push(`<option${ssrRenderAttr("value", f.value)}${ssrIncludeBooleanAttr(Array.isArray(unref(langForm).flag_icon) ? ssrLooseContain(unref(langForm).flag_icon, f.value) : ssrLooseEqual(unref(langForm).flag_icon, f.value)) ? " selected" : ""}>${ssrInterpolate(f.label)}</option>`);
      });
      ...
      ssrRenderList(unref(settingStore).languages, (lang, i) => {
        _push(`<tr><td>${ssrInterpolate(i + 1)}</td><td>${ssrInterpolate(lang.lang_name)}</td><td><img${ssrRenderAttr("src", `/flag/${lang.flag_icon}`)} style="${ssrRenderStyle({ "width": "20px", "height": "14px", "border-radius": "2px" })}"></td><td>`);
        if (lang.is_default) {
...
//# sourceMappingURL=language-DvC6ey78.mjs.map
