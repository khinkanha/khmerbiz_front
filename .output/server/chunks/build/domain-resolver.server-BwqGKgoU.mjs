import { v as defineEventHandler, w as getHeader } from '../nitro/nitro.mjs';
...
const domainResolver_server = defineEventHandler(async (event) => {
  var _a;
  const host = (_a = getHeader(event, "host")) == null ? void 0 : _a.replace(/^www\./, "");
...
export { domainResolver_server as default };
//# sourceMappingURL=domain-resolver.server-BwqGKgoU.mjs.map
