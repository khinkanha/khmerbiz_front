import { _ as __nuxt_component_0, a as __nuxt_component_1, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5, f as _sfc_main$1 } from './ArticleSection-CkZe_zP5.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-content" }, _attrs))} data-v-cabc2f38><div class="container" data-v-cabc2f38>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-cabc2f38>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`<p data-v-cabc2f38>${ssrInterpolate(_ctx.$t("common.loading"))}</p></div>`);
      } else if (unref(contentSection)) {
        _push(`<section class="section" data-v-cabc2f38>`);
        if (unref(contentSection).content.content_type === unref(ContentType).NEWS) {
          _push(ssrRenderComponent(_component_NewsSection, {
            ...
            "section-description": unref(contentSection).content.description
          }, null, _parent));
        ...
        _push(`<div class="empty-state" data-v-cabc2f38><p data-v-cabc2f38>${ssrInterpolate(_ctx.$t("common.noContent") || "No content available")}</p></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const _menuId_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cabc2f38"]]);

export { _menuId_ as default };
//# sourceMappingURL=_menuId_-C2XHxL4U.mjs.map
