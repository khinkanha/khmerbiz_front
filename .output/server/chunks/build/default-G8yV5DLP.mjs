import { _ as __nuxt_component_0$1, a as __nuxt_component_3 } from './DesignerFooter-DMeC05L2.mjs';
import { defineComponent, computed, resolveComponent, unref, ref, watch, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext } from 'vue';
import { ssrRenderClass, ssrRenderStyle, ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { u as useDomainStore } from './domain-CF4nfyOM.mjs';
import { _ as _export_sfc, k as useRoute, b as useRuntimeConfig, g as useI18n, n as navigateTo } from './server.mjs';
...
import { u as useDesignStore, b as designTokensToCssVars, g as getSocialIcon } from './setting-B7aDaTtz.mjs';
import { u as useSeo } from './useSeo-bD-N3JeE.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lang2" }, _attrs))} data-v-a08907ef><!--[-->`);
      ssrRenderList(unref(domainStore).languages, (lang) => {
        _push(`<div data-v-a08907ef>`);
        _push(ssrRenderComponent(_component_Button, {
          onClick: () => setLanguage(lang.lang_id),
          class: ["language-button", lang.lang_id === unref(currentLanguage).lang_id ? "active-language" : ""],
          text: ""
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", `/flag/${flagMap(lang.flag)}`)}${ssrRenderAttr("alt", lang.lang_name)} class="flag-icon" data-v-a08907ef${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
                  src: `/flag/${flagMap(lang.flag)}`,
                  alt: lang.lang_name,
                  class: "flag-icon"
                }, null, 8, ["src", "alt"])
              ];
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a08907ef"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({
        class: ["public-header stiky-header", unref(headerClass)]
      }, _attrs))} data-v-c54d60bd><div class="flag" data-v-c54d60bd>`);
      _push(ssrRenderComponent(_component_LanguageSelector, null, null, _parent));
      _push(`</div>`);
      if (unref(logoPos) !== 3) {
        _push(`<div class="top-bar" data-v-c54d60bd><div class="container top-bar-inner" data-v-c54d60bd><div class="brand" data-v-c54d60bd>`);
        if ((_a = unref(settings)) == null ? void 0 : _a.logo) {
          _push(`<!--[--><img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_b = unref(settings)) == null ? void 0 : _b.title) || "Logo")} class="brand-logo desktop-logo" data-v-c54d60bd>`);
          if ((_c = unref(settings)) == null ? void 0 : _c.mobile_logo) {
            _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_d = unref(settings)) == null ? void 0 : _d.title) || "Logo")} class="brand-logo mobile-logo" data-v-c54d60bd>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
      ...
      _push(`<div class="mobile-logo-bar" data-v-c54d60bd><div class="container mobile-logo-inner" data-v-c54d60bd>`);
      if ((_e = unref(settings)) == null ? void 0 : _e.mobile_logo) {
        _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_f = unref(settings)) == null ? void 0 : _f.title) || "Logo")} class="mobile-logo-img" data-v-c54d60bd>`);
      } else if ((_g = unref(settings)) == null ? void 0 : _g.title) {
        _push(`<div class="mobile-logo-title" data-v-c54d60bd><h1 data-v-c54d60bd>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><nav class="navbar" data-v-c54d60bd><div class="container navbar-container" data-v-c54d60bd><div class="navbar-brand-group" data-v-c54d60bd><div class="mobile-brand" data-v-c54d60bd>`);
      if ((_h = unref(settings)) == null ? void 0 : _h.title) {
        _push(`<div class="brand-title" data-v-c54d60bd><h1 data-v-c54d60bd>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      ...
      _push(`<button class="navbar-toggler" type="button" aria-label="Toggle navigation" data-v-c54d60bd><i class="${ssrRenderClass(unref(mobileMenuOpen) ? "pi pi-times" : "pi pi-bars")}" data-v-c54d60bd></i></button></div><div class="${ssrRenderClass([unref(navMenuClass), "navbar-menu"])}" data-v-c54d60bd><ul class="${ssrRenderClass([unref(menuAlignClass), "navbar-nav"])}" data-v-c54d60bd><!--[-->`);
      ssrRenderList(unref(filteredMenuTree), (item) => {
        var _a2;
        _push(`<li class="${ssrRenderClass([{ dropdown: item.children && item.children.length > 0, "show-dropdown": unref(expandedMenuId) === item.item_id }, "nav-item"])}" data-v-c54d60bd>`);
        if (item.children && item.children.length > 0) {
          _push(`<!--[-->`);
          if (unref(isSinglePage)) {
            _push(`<a${ssrRenderAttr("href", `#section-${item.item_id}`)} class="${ssrRenderClass([{ active: unref(activeMenuId) === item.item_id }, "nav-link"])}" data-v-c54d60bd>${ssrInterpolate(item.item_name)}</a>`);
          } else {
            _push(`<a href="#" class="${ssrRenderClass([{ active: isMenuActive(item) }, "nav-link dropdown-toggle"])}" data-v-c54d60bd>${ssrInterpolate(item.item_name)} <i class="${ssrRenderClass([unref(expandedMenuId) === item.item_id ? "pi-chevron-up" : "pi-chevron-down", "pi toggle-icon"])}" data-v-c54d60bd></i></a>`);
          }
          _push(`<ul class="dropdown-menu" data-v-c54d60bd><!--[-->`);
          ssrRenderList(item.children, (child) => {
            var _a3;
            _push(`<li data-v-c54d60bd>`);
            if (unref(isSinglePage)) {
              _push(`<a class="dropdown-item"${ssrRenderAttr("href", `#section-${child.item_id}`)} data-v-c54d60bd>${ssrInterpolate(child.item_name)}</a>`);
            } else {
              _push(ssrRenderComponent(_component_NuxtLink, {
                class: ["dropdown-item", { active: isChildActive(child.item_id) }],
      ...
      if (unref(logoPos) === 3) {
        _push(`<div class="top-bar bottom-bar" data-v-c54d60bd><div class="container top-bar-inner" data-v-c54d60bd><div class="brand" data-v-c54d60bd>`);
        if ((_i = unref(settings)) == null ? void 0 : _i.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_j = unref(settings)) == null ? void 0 : _j.title) || "Logo")} class="brand-logo" data-v-c54d60bd>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c54d60bd"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      var _a, _b, _c, _d;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "public-footer" }, _attrs))} data-v-3e26e50b><div class="footer-main" data-v-3e26e50b><div class="container" data-v-3e26e50b><div class="footer-grid" data-v-3e26e50b><div class="footer-section footer-about" data-v-3e26e50b><div class="footer-brand" data-v-3e26e50b>`);
      if ((_a = unref(settings)) == null ? void 0 : _a.mobile_logo) {
        _push(`<img${ssrRenderAttr("src", unref(photoUrl) + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_b = unref(settings)) == null ? void 0 : _b.title) || "Logo")} class="footer-logo" data-v-3e26e50b>`);
      } else {
        _push(`<!---->`);
      }
      if ((_c = unref(settings)) == null ? void 0 : _c.title) {
        _push(`<h3 data-v-3e26e50b>${ssrInterpolate(unref(settings).title)}</h3>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="footer-section" data-v-3e26e50b><h4 class="footer-heading" data-v-3e26e50b>${ssrInterpolate(_ctx.$t("settings.socialMedia"))}</h4><div class="social-links" data-v-3e26e50b><!--[-->`);
      ssrRenderList(unref(socialMedia), (social) => {
        _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-link" data-v-3e26e50b><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-3e26e50b></i></a>`);
      });
      _push(`<!--]--></div></div></div></div></div><div class="footer-bottom" data-v-3e26e50b><div class="container" data-v-3e26e50b>`);
      if ((_d = unref(settings)) == null ? void 0 : _d.footer) {
        _push(`<div class="${ssrRenderClass([unref(footerAlignClass), "footer-text"])}" data-v-3e26e50b>${(_a2 = unref(settings).footer) != null ? _a2 : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3e26e50b"]]);
const useTheme = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const route = useRoute();
    const settings = computed(() => domainStore.settings);
    const designStyleVars = computed(() => {
      var _a;
      return designTokensToCssVars((_a = designStore.design) == null ? void 0 : _a.style);
    });
    ...
    useHead({
      titleTemplate: () => {
        var _a;
        return ((_a = domainStore.settings) == null ? void 0 : _a.title) || "";
      }
    });
    ...
    const isDesignerMode = computed(() => {
      var _a;
      return Number((_a = settings.value) == null ? void 0 : _a.page_style) === 4;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      var _a;
      const _component_DesignerHeader = __nuxt_component_0$1;
      const _component_PublicHeader = __nuxt_component_1;
      const _component_BannerSlideshow = __nuxt_component_2;
      const _component_DesignerFooter = __nuxt_component_3;
      const _component_PublicFooter = __nuxt_component_4;
      const _component_ProgressSpinner = resolveComponent("ProgressSpinner");
      _push(`<!--[--><div class="${ssrRenderClass([unref(themeClass), "public-layout"])}" style="${ssrRenderStyle(unref(designStyleVars))}" data-v-31d59bb8>`);
      if (unref(isReady)) {
        _push(`<!--[-->`);
        if (unref(isDesignerMode)) {
          _push(ssrRenderComponent(_component_DesignerHeader, null, null, _parent));
        } else {
      ...
      _push(`<main class="main-content" data-v-31d59bb8>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main>`);
      if (unref(isReady)) {
        _push(`<!--[-->`);
        if (unref(isDesignerMode)) {
          _push(ssrRenderComponent(_component_DesignerFooter, null, null, _parent));
        } else {
        ...
        if (unref(showPlugin) && ((_a = unref(settings)) == null ? void 0 : _a.chat_script)) {
          _push(`<div data-v-31d59bb8>${(_a2 = unref(settings).chat_script) != null ? _a2 : ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      ...
      _push(`</div>`);
      if (!unref(isReady)) {
        _push(`<div class="app-loading" data-v-31d59bb8>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-31d59bb8"]]);

export { _default as default };
//# sourceMappingURL=default-G8yV5DLP.mjs.map
