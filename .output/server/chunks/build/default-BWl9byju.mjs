...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-ec07dd85>`);
      if (unref(logoPos) !== 3) {
        _push(`<div class="top-bar" data-v-ec07dd85><div class="container top-bar-inner" data-v-ec07dd85><div class="brand" data-v-ec07dd85>`);
        if (((_a = unref(settings)) == null ? void 0 : _a.logo) && !((_b = unref(settings)) == null ? void 0 : _b.mobile_logo)) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_c = unref(settings)) == null ? void 0 : _c.title) || "Logo")} class="brand-logo" data-v-ec07dd85>`);
        } else if ((_d = unref(settings)) == null ? void 0 : _d.logo) {
          _push(`<!--[--><img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_e = unref(settings)) == null ? void 0 : _e.title) || "Logo")} class="brand-logo desktop-logo" data-v-ec07dd85>`);
          if ((_f = unref(settings)) == null ? void 0 : _f.mobile_logo) {
            _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_g = unref(settings)) == null ? void 0 : _g.title) || "Logo")} class="brand-logo mobile-logo" data-v-ec07dd85>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
        ...
        if ((_h = unref(settings)) == null ? void 0 : _h.title) {
          _push(`<div class="brand-title" data-v-ec07dd85><h1 data-v-ec07dd85>${ssrInterpolate(unref(settings).title)}</h1></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="top-actions" data-v-ec07dd85>`);
        _push(ssrRenderComponent(_component_LanguageSelector, null, null, _parent));
        _push(`</div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<nav class="nav-bar" data-v-ec07dd85><div class="container nav-inner" data-v-ec07dd85>`);
      if (unref(logoPos) === 2) {
        _push(`<div class="brand brand-inline" data-v-ec07dd85>`);
        if ((_i = unref(settings)) == null ? void 0 : _i.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_j = unref(settings)) == null ? void 0 : _j.title) || "Logo")} class="brand-logo brand-logo-small" data-v-ec07dd85>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<ul class="${ssrRenderClass([unref(navListClass), "nav-list"])}" data-v-ec07dd85><!--[-->`);
      ssrRenderList(unref(filteredMenuTree), (item) => {
        var _a2;
        _push(`<li class="${ssrRenderClass([{ "has-dropdown": item.children && item.children.length > 0 }, "nav-item"])}" data-v-ec07dd85>`);
        if (unref(isSinglePage)) {
          _push(`<a${ssrRenderAttr("href", `#section-${item.item_id}`)} class="${ssrRenderClass([{ active: unref(activeMenuId) === item.item_id }, "nav-link"])}" data-v-ec07dd85>${ssrInterpolate(item.item_name)}</a>`);
        } else {
        ...
        if (item.children && item.children.length > 0) {
          _push(`<div class="dropdown-menu" data-v-ec07dd85><div class="dropdown-inner" data-v-ec07dd85>`);
          if (unref(isSinglePage)) {
            _push(`<!--[-->`);
            ssrRenderList(item.children, (child) => {
              _push(`<a${ssrRenderAttr("href", `#section-${child.item_id}`)} class="dropdown-link" data-v-ec07dd85>${ssrInterpolate(child.item_name)}</a>`);
            });
            _push(`<!--]-->`);
          } else {
            _push(`<!--[-->`);
      ...
      _push(`<button class="mobile-toggle" data-v-ec07dd85><i class="${ssrRenderClass(unref(mobileMenuOpen) ? "pi pi-times" : "pi pi-bars")}" data-v-ec07dd85></i></button></div></nav>`);
      if (unref(logoPos) === 3) {
        _push(`<div class="top-bar bottom-bar" data-v-ec07dd85><div class="container top-bar-inner" data-v-ec07dd85><div class="brand" data-v-ec07dd85>`);
        if ((_k = unref(settings)) == null ? void 0 : _k.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_l = unref(settings)) == null ? void 0 : _l.title) || "Logo")} class="brand-logo" data-v-ec07dd85>`);
        } else {
          _push(`<!---->`);
        }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ec07dd85"]]);
...
//# sourceMappingURL=default-BWl9byju.mjs.map
