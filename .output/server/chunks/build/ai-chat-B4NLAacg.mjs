...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrGetDirectiveProps, ssrRenderList, ssrRenderClass, ssrRenderStyle } from 'vue/server-renderer';
...
const useAIChat = () => {
  ...
  const respondToInput = async (inputId, value, messageId) => {
    var _a2;
    var _a;
    try {
      const response = await api.post(
        `/ai-chat/respond/${inputId}`,
        { value }
      );
      const msg = chatStore.messages.find((m) => m.id === messageId);
      if (msg && msg.toolCalls) {
        msg.toolCalls = msg.toolCalls.map(
          (tc) => {
            var _a3;
            var _a22, _b, _c;
            return tc.inputId === inputId ? {
              ...tc,
              needsInput: false,
              success: (_a3 = (_a22 = response.data) == null ? void 0 : _a22.success) != null ? _a3 : response.success,
              result: (_b = response.data) == null ? void 0 : _b.result,
              error: (_c = response.data) == null ? void 0 : _c.error
            } : tc;
          }
        );
        chatStore.updateMessage(messageId, { toolCalls: msg.toolCalls });
      ...
      return { success: false, error: error2.message || "Failed to submit selection" };
    }
  };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleRespond = async (tool, messageId) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      let _temp0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ai-chat-container" }, _attrs))} data-v-37b2bd65><div class="chat-header" data-v-37b2bd65><div class="header-left" data-v-37b2bd65><span${ssrRenderAttrs(_temp0 = mergeProps({
        class: ["health-dot", aiHealthy.value === true ? "healthy" : aiHealthy.value === false ? "unhealthy" : "unknown"]
      }, ssrGetDirectiveProps(_ctx, _directive_tooltip, aiHealthy.value ? "AI service online" : "AI service unavailable")))} data-v-37b2bd65>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : (_a = _temp0.innerHTML) != null ? _a : ""}</span><h3 data-v-37b2bd65>AI Assistant</h3>`);
      if (unref(usageInfo)) {
      ...
      _push(`</div><div class="header-right" data-v-37b2bd65>`);
      ...
      _push(`</div></div>`);
      if (showHistory.value) {
        _push(`<div class="history-panel" data-v-37b2bd65><div class="history-header" data-v-37b2bd65><span class="history-title" data-v-37b2bd65><i class="pi pi-history" data-v-37b2bd65></i> Recent Operations</span>`);
        _push(ssrRenderComponent(_component_Button, {
          icon: "pi pi-times",
          class: "p-button-text p-button-sm",
          onClick: ($event) => showHistory.value = false
        }, null, _parent));
        _push(`</div><div class="history-list" data-v-37b2bd65>`);
        if (historyLoading.value) {
          _push(`<div class="history-empty" data-v-37b2bd65>`);
          _push(ssrRenderComponent(_component_ProgressSpinner, {
            style: { "width": "20px", "height": "20px" },
            strokeWidth: "4"
          }, null, _parent));
          _push(`<span data-v-37b2bd65>Loading...</span></div>`);
        } else if (historyItems.value.length === 0) {
          _push(`<div class="history-empty" data-v-37b2bd65> No operations yet </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(historyItems.value, (op) => {
          _push(`<div class="history-item" data-v-37b2bd65><div class="history-item-left" data-v-37b2bd65><i class="${ssrRenderClass(["pi", getOperationIcon(op.operation_type)])}" style="${ssrRenderStyle({ color: getOperationColor(op.operation_type) })}" data-v-37b2bd65></i><div class="history-item-info" data-v-37b2bd65><span class="history-item-desc" data-v-37b2bd65>${ssrInterpolate(formatOperationDescription(op))}</span><span class="history-item-time" data-v-37b2bd65>${ssrInterpolate(formatOperationTime(op.created_at))}</span></div></div><div class="history-item-right" data-v-37b2bd65>`);
          _push(ssrRenderComponent(_component_Tag, {
            value: op.status,
      ...
      if (aiHealthy.value === false) {
        _push(ssrRenderComponent(_component_Message, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<strong data-v-37b2bd65${_scopeId}>AI service is currently unavailable.</strong> Please try again later. `);
            } else {
              return [
      ...
      _push(`<div class="messages-container" data-v-37b2bd65>`);
      if (!unref(hasMessages)) {
        _push(`<div class="empty-state" data-v-37b2bd65><i class="pi pi-android" style="${ssrRenderStyle({ "font-size": "3rem", "color": "#6366f1" })}" data-v-37b2bd65></i><h4 data-v-37b2bd65>Ask AI anything about your website</h4><div class="ai-capabilities" data-v-37b2bd65><div class="capability-group" data-v-37b2bd65><div class="capability-title" data-v-37b2bd65><i class="pi pi-bolt" data-v-37b2bd65></i> Quick Setup</div><ul class="suggestions" data-v-37b2bd65><li data-v-37b2bd65>&quot;Create a fresh website for my business&quot;</li><li data-v-37b2bd65>&quot;Apply a portfolio template to my site&quot;</li></ul></div><div class="capability-group" data-v-37b2bd65><div class="capability-title" data-v-37b2bd65><i class="pi pi-palette" data-v-37b2bd65></i> Themes &amp; Layout</div><ul class="suggestions" data-v-37b2bd65><li data-v-37b2bd65>&quot;Change my theme to purple&quot;</li><li data-v-37b2bd65>&quot;Switch to magazine layout&quot;</li><li data-v-37b2bd65>&quot;Move the logo to the left and menu to the top&quot;</li></ul></div><div class="capability-group" data-v-37b2bd65><div class="capability-title" data-v-37b2bd65><i class="pi pi-file" data-v-37b2bd65></i> Content &amp; Articles</div><ul class="suggestions" data-v-37b2bd65><li data-v-37b2bd65>&quot;Create a new article about our services&quot;</li><li data-v-37b2bd65>&quot;Update my home page content&quot;</li><li data-v-37b2bd65>&quot;Create a new page called Team&quot;</li></ul></div><div class="capability-group" data-v-37b2bd65><div class="capability-title" data-v-37b2bd65><i class="pi pi-bars" data-v-37b2bd65></i> Menu Management</div><ul class="suggestions" data-v-37b2bd65><li data-v-37b2bd65>&quot;Add a Services menu item&quot;</li><li data-v-37b2bd65>&quot;Reorder my menu items&quot;</li><li data-v-37b2bd65>&quot;Delete the Contact Us menu&quot;</li></ul></div><div class="capability-group" data-v-37b2bd65><div class="capability-title" data-v-37b2bd65><i class="pi pi-image" data-v-37b2bd65></i> Banners &amp; News</div><ul class="suggestions" data-v-37b2bd65><li data-v-37b2bd65>&quot;Create a news article about our latest product launch&quot;</li><li data-v-37b2bd65>&quot;Change the banner display style&quot;</li></ul></div><div class="capability-group" data-v-37b2bd65><div class="capability-title" data-v-37b2bd65><i class="pi pi-search" data-v-37b2bd65></i> SEO</div><ul class="suggestions" data-v-37b2bd65><li data-v-37b2bd65>&quot;Generate SEO keywords for my content&quot; </li><li data-v-37b2bd65>&quot;Update SEO metadata for my home page&quot; </li></ul></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(unref(messages), (message) => {
        var _a2;
        _push(`<div class="${ssrRenderClass(["message", message.role])}" data-v-37b2bd65><div class="message-header" data-v-37b2bd65><span class="message-role" data-v-37b2bd65>${ssrInterpolate(message.role === "user" ? "You" : "AI Assistant")}</span><span class="message-time" data-v-37b2bd65>${ssrInterpolate(formatTime(message.timestamp))}</span></div>`);
        if (message.role === "assistant") {
          _push(`<div class="message-content markdown-body" data-v-37b2bd65>${(_a2 = unref(renderMarkdown)(message.content)) != null ? _a2 : ""}</div>`);
        } else {
          _push(`<div class="message-content" data-v-37b2bd65>${ssrInterpolate(message.content)}</div>`);
        }
        if (message.toolCalls && message.toolCalls.length > 0) {
          _push(`<div class="tool-calls" data-v-37b2bd65><div class="tool-calls-header" data-v-37b2bd65><i class="pi pi-cog" data-v-37b2bd65></i> Actions performed: </div><!--[-->`);
          ssrRenderList(message.toolCalls, (tool, index) => {
            _push(`<div class="${ssrRenderClass(["tool-call", tool.needsConfirmation || tool.needsInput ? "pending" : tool.success ? "success" : "error"])}" data-v-37b2bd65><div class="tool-call-top" data-v-37b2bd65><div class="tool-name" data-v-37b2bd65><i class="${ssrRenderClass(["pi", getToolIcon(tool.toolName)])}" data-v-37b2bd65></i> ${ssrInterpolate(formatToolName(tool.toolName))}</div>`);
            ...
            if (tool.needsConfirmation) {
              _push(`<div class="tool-confirmation" data-v-37b2bd65><div class="confirmation-preview" data-v-37b2bd65><i class="pi pi-exclamation-triangle" data-v-37b2bd65></i> ${ssrInterpolate(tool.confirmationPreview)}</div><div class="confirmation-actions" data-v-37b2bd65>`);
              _push(ssrRenderComponent(_component_Button, {
                label: "Confirm",
                icon: "pi pi-check",
                severity: "danger",
              ...
              _push(`<div class="tool-input" data-v-37b2bd65><div class="input-prompt" data-v-37b2bd65><i class="pi pi-question-circle" data-v-37b2bd65></i> ${ssrInterpolate(tool.inputPrompt || "Please choose an option to continue")}</div><div class="input-actions" data-v-37b2bd65>`);
              _push(ssrRenderComponent(_component_Dropdown, {
                modelValue: inputSelections.value[tool.inputId],
                "onUpdate:modelValue": ($event) => inputSelections.value[tool.inputId] = $event,
              ...
              _push(ssrRenderComponent(_component_Button, {
                ...
                severity: "primary",
                size: "small",
                loading: responding.value[tool.inputId],
                disabled: inputSelections.value[tool.inputId] === void 0 || inputSelections.value[tool.inputId] === null,
                onClick: ($event) => handleRespond(tool, message.id)
              }, null, _parent));
              _push(`</div></div>`);
            } else if (tool.success) {
              _push(`<div class="tool-result" data-v-37b2bd65>${ssrInterpolate(formatToolResult(tool))}</div>`);
            } else if (tool.error) {
              _push(`<div class="${ssrRenderClass(["tool-error", getErrorCategory(tool.error)])}" data-v-37b2bd65><i class="${ssrRenderClass(["pi", getErrorIcon(tool.error)])}" data-v-37b2bd65></i><span data-v-37b2bd65>${ssrInterpolate(tool.error)}</span></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        if (message.loading) {
          _push(`<div class="message-loading" data-v-37b2bd65>`);
          _push(ssrRenderComponent(_component_ProgressSpinner, {
            style: { "width": "20px", "height": "20px" },
            strokeWidth: "4"
          }, null, _parent));
          _push(`<span data-v-37b2bd65>AI is thinking...</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="input-area" data-v-37b2bd65><div class="input-wrapper" data-v-37b2bd65>`);
      ...
      _push(`<div class="input-footer" data-v-37b2bd65><span class="input-hint" data-v-37b2bd65>Ctrl + Enter to send</span>`);
      _push(ssrRenderComponent(_component_Button, {
        icon: "pi pi-send",
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-37b2bd65"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ai-chat-page" }, _attrs))} data-v-b7eb69fd><div class="page-header" data-v-b7eb69fd><h1 data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.page.title"))}</h1><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.page.subtitle"))}</p></div><div class="chat-layout" data-v-b7eb69fd><div class="chat-main" data-v-b7eb69fd>`);
      _push(ssrRenderComponent(_component_AIChat, null, null, _parent));
      _push(`</div><div class="chat-sidebar" data-v-b7eb69fd><div class="sidebar-section" data-v-b7eb69fd><h3 data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilitiesTitle"))}</h3><ul class="capability-list" data-v-b7eb69fd><li data-v-b7eb69fd><i class="pi pi-bolt" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.setup.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.setup.desc"))}</p></div></li><li data-v-b7eb69fd><i class="pi pi-th-large" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.templates.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.templates.desc"))}</p></div></li><li data-v-b7eb69fd><i class="pi pi-palette" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.theme.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.theme.desc"))}</p></div></li><li data-v-b7eb69fd><i class="pi pi-file" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.pages.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.pages.desc"))}</p></div></li><li data-v-b7eb69fd><i class="pi pi-bars" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.menu.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.menu.desc"))}</p></div></li><li data-v-b7eb69fd><i class="pi pi-image" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.banners.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.banners.desc"))}</p></div></li><li data-v-b7eb69fd><i class="pi pi-search" data-v-b7eb69fd></i><div data-v-b7eb69fd><strong data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.seo.title"))}</strong><p data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.capabilities.seo.desc"))}</p></div></li></ul></div><div class="sidebar-section" data-v-b7eb69fd><h3 data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.tipsTitle"))}</h3><ul class="tips-list" data-v-b7eb69fd><li data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.tips.specific"))}</li><li data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.tips.natural"))}</li><li data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.tips.confirm"))}</li><li data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.tips.undo"))}</li><li data-v-b7eb69fd>${ssrInterpolate(_ctx.$t("aiChat.sidebar.tips.reset"))}</li></ul></div></div></div></div>`);
    };
  }
});
...
const aiChat = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b7eb69fd"]]);

export { aiChat as default };
//# sourceMappingURL=ai-chat-B4NLAacg.mjs.map
