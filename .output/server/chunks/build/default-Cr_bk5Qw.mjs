...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="flag" data-v-12374dcf>`);
      _push(ssrRenderComponent(_component_LanguageSelector, null, null, _parent));
      _push(`</div><header class="${ssrRenderClass([unref(headerClass), "public-header"])}" data-v-12374dcf>`);
      if (unref(logoPos) !== 3) {
        _push(`<div class="top-bar" data-v-12374dcf><div class="container top-bar-inner" data-v-12374dcf><div class="brand" data-v-12374dcf>`);
        if ((_a = unref(settings)) == null ? void 0 : _a.logo) {
          _push(`<!--[--><img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_b = unref(settings)) == null ? void 0 : _b.title) || "Logo")} class="brand-logo desktop-logo" data-v-12374dcf>`);
          if ((_c = unref(settings)) == null ? void 0 : _c.mobile_logo) {
            _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_d = unref(settings)) == null ? void 0 : _d.title) || "Logo")} class="brand-logo mobile-logo" data-v-12374dcf>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
      ...
      _push(`<nav class="nav-bar" data-v-12374dcf><div class="container nav-inner" data-v-12374dcf><div class="mobile-brand" data-v-12374dcf>`);
      if ((_e = unref(settings)) == null ? void 0 : _e.mobile_logo) {
        _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).mobile_logo)}${ssrRenderAttr("alt", ((_f = unref(settings)) == null ? void 0 : _f.title) || "Logo")} class="brand-logo brand-logo-small" data-v-12374dcf>`);
      } else {
        _push(`<!---->`);
      }
      if ((_g = unref(settings)) == null ? void 0 : _g.title) {
        _push(`<div class="brand-title" data-v-12374dcf><h1 data-v-12374dcf>${ssrInterpolate(unref(settings).title)}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (unref(logoPos) === 2) {
        _push(`<div class="brand brand-inline" data-v-12374dcf>`);
        if ((_h = unref(settings)) == null ? void 0 : _h.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_i = unref(settings)) == null ? void 0 : _i.title) || "Logo")} class="brand-logo brand-logo-small" data-v-12374dcf>`);
        } else {
          _push(`<!---->`);
        }
      ...
      _push(`<ul class="${ssrRenderClass([unref(navListClass), "nav-list"])}" data-v-12374dcf><!--[-->`);
      ssrRenderList(unref(filteredMenuTree), (item) => {
        var _a2;
        _push(`<li class="${ssrRenderClass([{ "has-dropdown": item.children && item.children.length > 0 }, "nav-item"])}" data-v-12374dcf>`);
        if (unref(isSinglePage)) {
          _push(`<a${ssrRenderAttr("href", `#section-${item.item_id}`)} class="${ssrRenderClass([{ active: unref(activeMenuId) === item.item_id }, "nav-link"])}" data-v-12374dcf>${ssrInterpolate(item.item_name)}</a>`);
        } else {
        ...
        if (item.children && item.children.length > 0) {
          _push(`<div class="dropdown-menu" data-v-12374dcf><div class="dropdown-inner" data-v-12374dcf>`);
          if (unref(isSinglePage)) {
            _push(`<!--[-->`);
            ssrRenderList(item.children, (child) => {
              _push(`<a${ssrRenderAttr("href", `#section-${child.item_id}`)} class="dropdown-link" data-v-12374dcf>${ssrInterpolate(child.item_name)}</a>`);
            });
            _push(`<!--]-->`);
          } else {
            _push(`<!--[-->`);
      ...
      _push(`<button class="mobile-toggle" data-v-12374dcf><i class="${ssrRenderClass(unref(mobileMenuOpen) ? "pi pi-times" : "pi pi-bars")}" data-v-12374dcf></i></button></div></nav>`);
      if (unref(logoPos) === 3) {
        _push(`<div class="top-bar bottom-bar" data-v-12374dcf><div class="container top-bar-inner" data-v-12374dcf><div class="brand" data-v-12374dcf>`);
        if ((_k = unref(settings)) == null ? void 0 : _k.logo) {
          _push(`<img${ssrRenderAttr("src", unref(config).photoUrl + unref(settings).logo)}${ssrRenderAttr("alt", ((_l = unref(settings)) == null ? void 0 : _l.title) || "Logo")} class="brand-logo" data-v-12374dcf>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-12374dcf"]]);
...
//# sourceMappingURL=default-Cr_bk5Qw.mjs.map
