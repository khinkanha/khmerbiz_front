...
import { defineComponent, ref, computed, resolveComponent, resolveDirective, mergeProps, withCtx, createTextVNode, toDisplayString, unref, createVNode, isRef, openBlock, createBlock, createCommentVNode, withDirectives, withModifiers, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fetchAllMenus = async () => {
      loading.value = true;
      try {
        const res = await api.get("/menus?limit=1000");
    ...
    const flatMenuItems = computed(() => {
      ...
      return allMenus.value.filter((m) => selectedLangId.value && m.lang_id === selectedLangId.value).filter((m) => {
        if (seen.has(m.item_id)) return false;
        seen.add(m.item_id);
        return true;
      }).sort((a, b) => (a.item_order || 0) - (b.item_order || 0)).map((m) => ({ ...m, _depth: 0 }));
    });
    const flagMap = (flag) => {
      const flags = {
        0: "kh.svg",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "row" }, _attrs))} data-v-bd7e2398><div class="col-md-3" data-v-bd7e2398><ul class="nav nav-pills nav-stacked" data-v-bd7e2398><li class="${ssrRenderClass({ active: true })}" data-v-bd7e2398>`);
      ...
      _push(`</li><li data-v-bd7e2398><a href="#" data-v-bd7e2398>Clear Cache</a></li></ul></div><div class="col-md-9" data-v-bd7e2398>`);
      if (unref(clearMsg)) {
        _push(`<div class="alert alert-success" data-v-bd7e2398>Menu Cache has been cleared.</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="text-right" style="${ssrRenderStyle({ "margin-bottom": "10px" })}" data-v-bd7e2398>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="fa fa-plus" data-v-bd7e2398${_scopeId}></i>`);
          } else {
            return [
      ...
      _push(`</div><div class="text-right" style="${ssrRenderStyle({ "margin-bottom": "10px" })}" data-v-bd7e2398>`);
      _push(ssrRenderComponent(_component_Dropdown, {
        modelValue: unref(selectedLangId),
        "onUpdate:modelValue": ($event) => isRef(selectedLangId) ? selectedLangId.value = $event : null,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data._depth > 0) {
                          _push4(`<i class="fa fa-angle-right" style="${ssrRenderStyle({ "color": "#a0aec0", "margin-right": "4px" })}" data-v-bd7e2398${_scopeId3}></i>`);
                        } else {
                          _push4(`<!---->`);
                        }
                  ...
                  if (data.content_id) {
                    _push3(ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<i class="fa fa-eye" style="${ssrRenderStyle({ "color": "#3b82f6" })}" data-v-bd7e2398${_scopeId3}></i>`);
                        } else {
                          return [
                            createVNode("i", {
                              class: "fa fa-eye",
            ...
            _push2(ssrRenderComponent(_component_Column, {
              ...
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="reorder-btns" data-v-bd7e2398${_scopeId2}><a${ssrRenderAttrs(mergeProps({
                    href: "#",
                    class: ["btn btn-xs btn-default", { disabled: unref(loading) }]
                  }, ssrGetDirectiveProps(_ctx, _directive_tooltip, _ctx.$t("menuManager.moveUp"), void 0, { top: true })))} data-v-bd7e2398${_scopeId2}><i class="fa fa-arrow-up" data-v-bd7e2398${_scopeId2}></i></a><a${ssrRenderAttrs(mergeProps({
                    href: "#",
                    class: ["btn btn-xs btn-default", { disabled: unref(loading) }]
                  }, ssrGetDirectiveProps(_ctx, _directive_tooltip, _ctx.$t("menuManager.moveDown"), void 0, { top: true })))} data-v-bd7e2398${_scopeId2}><i class="fa fa-arrow-down" data-v-bd7e2398${_scopeId2}></i></a></div>`);
                } else {
                  return [
              ...
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (getLanguageByLangId(data.lang_id)) {
                    _push3(`<img${ssrRenderAttr("src", `/flag/${flagMap(getLanguageByLangId(data.lang_id).flag)}`)} style="${ssrRenderStyle({ "width": "20px", "height": "14px", "border-radius": "2px" })}" data-v-bd7e2398${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
            ...
            _push2(ssrRenderComponent(_component_Column, { style: { width: "80px" } }, {
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<a href="#" class="text-danger" data-v-bd7e2398${_scopeId2}>${ssrInterpolate(_ctx.$t("menuManager.delete"))}</a>`);
                } else {
                  return [
                    createVNode("a", {
                      href: "#",
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bd7e2398"]]);

export { index as default };
//# sourceMappingURL=index-CI9pJ898.mjs.map
