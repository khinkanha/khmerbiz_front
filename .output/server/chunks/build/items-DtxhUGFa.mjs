...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content-items-page" }, _attrs))} data-v-1684f317><div class="page-header" data-v-1684f317><div class="header-left" data-v-1684f317>`);
      _push(ssrRenderComponent(_component_Button, {
        icon: "pi pi-arrow-left",
        text: "",
        onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))(`/admin/content/${unref(contentId)}`)
      }, null, _parent));
      _push(`<h1 class="page-title" data-v-1684f317>${ssrInterpolate(_ctx.$t("contentManager.title"))}: ${ssrInterpolate((_a = unref(contentStore).currentContent) == null ? void 0 : _a.title)}</h1></div></div><div class="split-layout" data-v-1684f317>`);
      if (unref(showForm)) {
        _push(ssrRenderComponent(_component_Card, { class: "form-card" }, {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<form class="item-form" data-v-1684f317${_scopeId}><div class="form-group" data-v-1684f317${_scopeId}><label for="itemTitle" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.contentTitle"))} *</label>`);
              ...
              if (unref(itemErrors).title) {
                _push2(`<small class="p-error" data-v-1684f317${_scopeId}>${ssrInterpolate(unref(itemErrors).title)}</small>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              if (unref(isNewsContent)) {
                _push2(`<div class="form-group" data-v-1684f317${_scopeId}><label for="shortDescription" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.shortDescription"))}</label>`);
              ...
              _push2(`<div class="form-group" data-v-1684f317${_scopeId}><label for="itemDescription" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.description"))}</label>`);
              _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
              if (!unref(isNewsContent)) {
                _push2(`<textarea class="form-control" rows="4"${ssrRenderAttr("placeholder", _ctx.$t("contentManager.description"))} data-v-1684f317${_scopeId}>${ssrInterpolate(unref(itemForm).description)}</textarea>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
              if (unref(contentType) !== unref(ContentType).VIDEO) {
                _push2(`<div class="form-group" data-v-1684f317${_scopeId}><label data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.primaryImage"))}</label><div class="image-input-tabs" data-v-1684f317${_scopeId}>`);
                ...
                if (unref(imageInputMode) === "upload") {
                  _push2(`<div data-v-1684f317${_scopeId}>`);
                ...
                if (unref(itemForm).photoPreview) {
                  _push2(`<div class="photo-preview" data-v-1684f317${_scopeId}><img${ssrRenderAttr("src", unref(itemForm).photoPreview)} alt="Preview" data-v-1684f317${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_Button, {
                    icon: "pi pi-times",
                    rounded: "",
                    text: "",
              ...
              if (unref(contentType) === unref(ContentType).VIDEO) {
                _push2(`<div class="form-group" data-v-1684f317${_scopeId}><label for="videoUrl" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.videoLink"))}</label>`);
                _push2(ssrRenderComponent(_component_InputText, {
                  id: "videoUrl",
              ...
              if (unref(isNewsContent)) {
                _push2(`<div class="form-row" data-v-1684f317${_scopeId}><div class="form-group" data-v-1684f317${_scopeId}><label for="priority" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.priority"))}</label>`);
                ...
                _push2(`</div><div class="form-group" data-v-1684f317${_scopeId}><label for="isFeature" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.featureItem"))}</label>`);
              ...
              if (unref(isNewsContent)) {
                _push2(`<div class="form-row" data-v-1684f317${_scopeId}><div class="form-group" data-v-1684f317${_scopeId}><label for="publishDate" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.publishDate"))}</label>`);
                ...
                _push2(`</div><div class="form-group" data-v-1684f317${_scopeId}><label for="newsStatus" data-v-1684f317${_scopeId}>${ssrInterpolate(_ctx.$t("contentManager.status") || "Status")}</label><div class="status-toggle" data-v-1684f317${_scopeId}>`);
                ...
                _push2(`<span class="status-label" data-v-1684f317${_scopeId}>${ssrInterpolate(unref(itemForm).status ? _ctx.$t("contentManager.show") || "Show" : _ctx.$t("contentManager.notShow") || "Not Show")}</span></div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="form-actions" data-v-1684f317${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Button, {
                type: "button",
      ...
      _push(ssrRenderComponent(_component_Card, { class: "table-card" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "justify-content": "flex-end", "padding": "0.5rem 1rem" })}" data-v-1684f317${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data.photo || data.url) {
                          _push4(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${data.photo || data.url}`)}${ssrRenderAttr("alt", data.title)} class="item-thumb" data-v-1684f317${_scopeId3}>`);
                        } else {
                          _push4(`<span data-v-1684f317${_scopeId3}>-</span>`);
                        }
                      } else {
                        return [
                          data.photo || data.url ? (openBlock(), createBlock("img", {
                            key: 0,
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="action-buttons" data-v-1684f317${_scopeId3}>`);
...
const items = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1684f317"]]);

export { items as default };
//# sourceMappingURL=items-DtxhUGFa.mjs.map
