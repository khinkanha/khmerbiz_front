...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "test-page" }, _attrs))} data-v-340d3752><h1 data-v-340d3752>Test Page</h1><p data-v-340d3752>This is a test page to verify the layout and components. And It protected by authentication.</p></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-340d3752"]]);

export { index as default };
//# sourceMappingURL=index-B9OlwUSm.mjs.map
