...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      let _temp0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ai-chat-container" }, _attrs))} data-v-161f300b><div class="chat-header" data-v-161f300b><div class="header-left" data-v-161f300b><span${ssrRenderAttrs(_temp0 = mergeProps({
        class: ["health-dot", aiHealthy.value === true ? "healthy" : aiHealthy.value === false ? "unhealthy" : "unknown"]
      }, ssrGetDirectiveProps(_ctx, _directive_tooltip, aiHealthy.value ? "AI service online" : "AI service unavailable")))} data-v-161f300b>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : (_a = _temp0.innerHTML) != null ? _a : ""}</span><h3 data-v-161f300b>AI Assistant</h3>`);
      if (unref(usageInfo)) {
      ...
      _push(`</div><div class="header-right" data-v-161f300b>`);
      ...
      _push(`</div></div>`);
      if (showHistory.value) {
        _push(`<div class="history-panel" data-v-161f300b><div class="history-header" data-v-161f300b><span class="history-title" data-v-161f300b><i class="pi pi-history" data-v-161f300b></i> Recent Operations</span>`);
        _push(ssrRenderComponent(_component_Button, {
          icon: "pi pi-times",
          class: "p-button-text p-button-sm",
          onClick: ($event) => showHistory.value = false
        }, null, _parent));
        _push(`</div><div class="history-list" data-v-161f300b>`);
        if (historyLoading.value) {
          _push(`<div class="history-empty" data-v-161f300b>`);
          _push(ssrRenderComponent(_component_ProgressSpinner, {
            style: { "width": "20px", "height": "20px" },
            strokeWidth: "4"
          }, null, _parent));
          _push(`<span data-v-161f300b>Loading...</span></div>`);
        } else if (historyItems.value.length === 0) {
          _push(`<div class="history-empty" data-v-161f300b> No operations yet </div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
        ssrRenderList(historyItems.value, (op) => {
          _push(`<div class="history-item" data-v-161f300b><div class="history-item-left" data-v-161f300b><i class="${ssrRenderClass(["pi", getOperationIcon(op.operation_type)])}" style="${ssrRenderStyle({ color: getOperationColor(op.operation_type) })}" data-v-161f300b></i><div class="history-item-info" data-v-161f300b><span class="history-item-desc" data-v-161f300b>${ssrInterpolate(formatOperationDescription(op))}</span><span class="history-item-time" data-v-161f300b>${ssrInterpolate(formatOperationTime(op.created_at))}</span></div></div><div class="history-item-right" data-v-161f300b>`);
          _push(ssrRenderComponent(_component_Tag, {
            value: op.status,
      ...
      if (aiHealthy.value === false) {
        _push(ssrRenderComponent(_component_Message, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<strong data-v-161f300b${_scopeId}>AI service is currently unavailable.</strong> Please try again later. `);
            } else {
              return [
      ...
      _push(`<div class="messages-container" data-v-161f300b>`);
      if (!unref(hasMessages)) {
        _push(`<div class="empty-state" data-v-161f300b><i class="pi pi-android" style="${ssrRenderStyle({ "font-size": "3rem", "color": "#6366f1" })}" data-v-161f300b></i><h4 data-v-161f300b>Ask AI anything about your website</h4><div class="ai-capabilities" data-v-161f300b><div class="capability-group" data-v-161f300b><div class="capability-title" data-v-161f300b><i class="pi pi-bolt" data-v-161f300b></i> Quick Setup</div><ul class="suggestions" data-v-161f300b><li data-v-161f300b>&quot;Create a fresh website for my business&quot;</li><li data-v-161f300b>&quot;Apply a portfolio template to my site&quot;</li></ul></div><div class="capability-group" data-v-161f300b><div class="capability-title" data-v-161f300b><i class="pi pi-palette" data-v-161f300b></i> Themes &amp; Layout</div><ul class="suggestions" data-v-161f300b><li data-v-161f300b>&quot;Change my theme to purple&quot;</li><li data-v-161f300b>&quot;Switch to magazine layout&quot;</li><li data-v-161f300b>&quot;Move the logo to the left and menu to the top&quot;</li></ul></div><div class="capability-group" data-v-161f300b><div class="capability-title" data-v-161f300b><i class="pi pi-file" data-v-161f300b></i> Content &amp; Articles</div><ul class="suggestions" data-v-161f300b><li data-v-161f300b>&quot;Create a new article about our services&quot;</li><li data-v-161f300b>&quot;Update my home page content&quot;</li><li data-v-161f300b>&quot;Create a new page called Team&quot;</li></ul></div><div class="capability-group" data-v-161f300b><div class="capability-title" data-v-161f300b><i class="pi pi-bars" data-v-161f300b></i> Menu Management</div><ul class="suggestions" data-v-161f300b><li data-v-161f300b>&quot;Add a Services menu item&quot;</li><li data-v-161f300b>&quot;Reorder my menu items&quot;</li><li data-v-161f300b>&quot;Delete the Contact Us menu&quot;</li></ul></div><div class="capability-group" data-v-161f300b><div class="capability-title" data-v-161f300b><i class="pi pi-image" data-v-161f300b></i> Banners &amp; News</div><ul class="suggestions" data-v-161f300b><li data-v-161f300b>&quot;Create a news article about our latest product launch&quot;</li><li data-v-161f300b>&quot;Change the banner display style&quot;</li></ul></div><div class="capability-group" data-v-161f300b><div class="capability-title" data-v-161f300b><i class="pi pi-search" data-v-161f300b></i> SEO</div><ul class="suggestions" data-v-161f300b><li data-v-161f300b>&quot;Generate SEO keywords for my content&quot;</li><li data-v-161f300b>&quot;Update SEO metadata for my home page&quot;</li></ul></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(unref(messages), (message) => {
        _push(`<div class="${ssrRenderClass(["message", message.role])}" data-v-161f300b><div class="message-header" data-v-161f300b><span class="message-role" data-v-161f300b>${ssrInterpolate(message.role === "user" ? "You" : "AI Assistant")}</span><span class="message-time" data-v-161f300b>${ssrInterpolate(formatTime(message.timestamp))}</span></div><div class="message-content" data-v-161f300b>${ssrInterpolate(message.content)}</div>`);
        if (message.toolCalls && message.toolCalls.length > 0) {
          _push(`<div class="tool-calls" data-v-161f300b><div class="tool-calls-header" data-v-161f300b><i class="pi pi-cog" data-v-161f300b></i> Actions performed: </div><!--[-->`);
          ssrRenderList(message.toolCalls, (tool, index) => {
            _push(`<div class="${ssrRenderClass(["tool-call", tool.needsConfirmation ? "pending" : tool.success ? "success" : "error"])}" data-v-161f300b><div class="tool-call-top" data-v-161f300b><div class="tool-name" data-v-161f300b><i class="${ssrRenderClass(["pi", getToolIcon(tool.toolName)])}" data-v-161f300b></i> ${ssrInterpolate(formatToolName(tool.toolName))}</div>`);
            ...
            if (tool.needsConfirmation) {
              _push(`<div class="tool-confirmation" data-v-161f300b><div class="confirmation-preview" data-v-161f300b><i class="pi pi-exclamation-triangle" data-v-161f300b></i> ${ssrInterpolate(tool.confirmationPreview)}</div><div class="confirmation-actions" data-v-161f300b>`);
              _push(ssrRenderComponent(_component_Button, {
                label: "Confirm",
                icon: "pi pi-check",
                severity: "danger",
              ...
              _push(`<div class="tool-result" data-v-161f300b>${ssrInterpolate(formatToolResult(tool))}</div>`);
            } else if (tool.error) {
              _push(`<div class="${ssrRenderClass(["tool-error", getErrorCategory(tool.error)])}" data-v-161f300b><i class="${ssrRenderClass(["pi", getErrorIcon(tool.error)])}" data-v-161f300b></i><span data-v-161f300b>${ssrInterpolate(tool.error)}</span></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        if (message.loading) {
          _push(`<div class="message-loading" data-v-161f300b>`);
          _push(ssrRenderComponent(_component_ProgressSpinner, {
            style: { "width": "20px", "height": "20px" },
            strokeWidth: "4"
          }, null, _parent));
          _push(`<span data-v-161f300b>AI is thinking...</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="input-area" data-v-161f300b><div class="input-wrapper" data-v-161f300b>`);
      ...
      _push(`<div class="input-footer" data-v-161f300b><span class="input-hint" data-v-161f300b>Ctrl + Enter to send</span>`);
      _push(ssrRenderComponent(_component_Button, {
        icon: "pi pi-send",
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-161f300b"]]);
...
//# sourceMappingURL=ai-chat-BtlLSVEg.mjs.map
