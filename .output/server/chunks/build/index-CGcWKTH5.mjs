import { defineComponent, ref, computed, watch, resolveComponent, unref, mergeProps, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_0$2, a as __nuxt_component_1, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5 } from './ArticleSection-BqNWEKJ6.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-c8dab374>`);
      if (unref(showBanners) && (unref(heroBanner) || __props.settings.background)) {
        _push(`<section class="${ssrRenderClass([unref(bannerPosClass), "hero-section"])}" data-v-c8dab374><div class="hero-background" style="${ssrRenderStyle({ backgroundImage: unref(heroBanner) ? `url(${unref(photoUrl)}${unref(heroBanner).photo})` : __props.settings.background ? `url(${__props.settings.background})` : "" })}" data-v-c8dab374></div><div class="hero-overlay" data-v-c8dab374></div><div class="hero-content" data-v-c8dab374><h1 class="hero-title" data-v-c8dab374>${ssrInterpolate(__props.settings.title || __props.settings.domain_name)}</h1>`);
        if (__props.settings.company_desc) {
          _push(`<p class="hero-subtitle" data-v-c8dab374>${ssrInterpolate(__props.settings.company_desc)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<nav class="anchor-nav" data-v-c8dab374><!--[-->`);
        ssrRenderList(__props.menuTree, (menuItem) => {
          _push(`<a${ssrRenderAttr("href", `#section-${menuItem.item_id}`)} class="anchor-link" data-v-c8dab374>${ssrInterpolate(menuItem.item_name)}</a>`);
        });
        _push(`<!--]--></nav></div><div class="scroll-indicator" data-v-c8dab374><span data-v-c8dab374>Scroll</span><i class="pi pi-chevron-down" data-v-c8dab374></i></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<main class="main-content" data-v-c8dab374><!--[-->`);
      ssrRenderList(__props.menuTree, (menuItem, index2) => {
        _push(`<div class="${ssrRenderClass([{ "section-left": index2 % 2 === 0, "section-right": index2 % 2 === 1 }, "content-section-wrapper"])}"${ssrRenderAttr("id", `section-${menuItem.item_id}`)} data-v-c8dab374><div class="section-inner" data-v-c8dab374><span class="section-number" data-v-c8dab374>${ssrInterpolate(String(index2 + 1).padStart(2, "0"))}</span><div class="${ssrRenderClass([{ "content-push-right": index2 % 2 === 1 }, "section-content"])}" data-v-c8dab374><div class="section-header" data-v-c8dab374><div class="section-line" data-v-c8dab374></div><h2 class="section-title" data-v-c8dab374>${ssrInterpolate(menuItem.item_name)}</h2></div>`);
        if (menuItem.children && menuItem.children.length > 0) {
          _push(`<div class="submenu-grid" data-v-c8dab374><!--[-->`);
          ssrRenderList(menuItem.children, (child) => {
            _push(`<div class="submenu-card"${ssrRenderAttr("id", `subsection-${child.item_id}`)} data-v-c8dab374>`);
          ...
          _push(`<div class="single-content" data-v-c8dab374>`);
          _push(ssrRenderComponent(_component_ContentRenderer, {
        ...
        if (index2 < __props.menuTree.length - 1) {
          _push(`<div class="section-divider" data-v-c8dab374><span data-v-c8dab374></span><span data-v-c8dab374></span><span data-v-c8dab374></span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<!--]--></main>`);
      if (__props.socialMedia.length > 0) {
        _push(`<section class="social-footer" data-v-c8dab374><div class="social-inner" data-v-c8dab374><!--[-->`);
        ssrRenderList(__props.socialMedia, (social) => {
          _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon-link" data-v-c8dab374><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-c8dab374></i></a>`);
        });
        _push(`<!--]--></div></section>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(showBackToTop)) {
        _push(`<button class="back-to-top" data-v-c8dab374><i class="pi pi-arrow-up" data-v-c8dab374></i></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const ScrollingSinglePage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c8dab374"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-cd3c9118>`);
      if (__props.settings && unref(showBanners)) {
        _push(`<section class="${ssrRenderClass([unref(bannerPosClass), "banner-bar"])}" data-v-cd3c9118><div class="banner-bar-inner" data-v-cd3c9118><div class="banner-bar-text" data-v-cd3c9118><h1 class="site-title" data-v-cd3c9118>${ssrInterpolate(__props.settings.title || __props.settings.domain_name)}</h1>`);
        if (__props.settings.company_desc) {
          _push(`<p class="site-desc" data-v-cd3c9118>${ssrInterpolate(__props.settings.company_desc)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (__props.banners.length > 0) {
          _push(`<div class="${ssrRenderClass([{ "multi": __props.banners.length > 1 }, "banner-grid"])}" data-v-cd3c9118><!--[-->`);
          ssrRenderList(__props.banners.slice(0, 3), (banner, i) => {
            _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${banner.image}`)}${ssrRenderAttr("alt", banner.title)} class="${ssrRenderClass([{ "span-2": __props.banners.length === 2 && i === 0 }, "banner-img"])}" data-v-cd3c9118>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
      ...
      _push(`<main class="main-content" data-v-cd3c9118><div class="content-layout" data-v-cd3c9118><div class="content-main" data-v-cd3c9118><!--[-->`);
      ssrRenderList(__props.menuTree, (menuItem, index2) => {
        _push(`<div class="magazine-section"${ssrRenderAttr("id", `section-${menuItem.item_id}`)} data-v-cd3c9118><div class="section-header" data-v-cd3c9118><h2 class="section-title" data-v-cd3c9118>${ssrInterpolate(menuItem.item_name)}</h2><span class="section-tag" data-v-cd3c9118>${ssrInterpolate(menuItem.item_name)}</span></div>`);
        if (menuItem.children && menuItem.children.length > 0) {
          _push(`<div class="editorial-grid" data-v-cd3c9118><!--[-->`);
          ssrRenderList(menuItem.children, (child, ci) => {
            _push(`<div class="${ssrRenderClass([{ "card-wide": ci === 0 }, "editorial-card"])}"${ssrRenderAttr("id", `subsection-${child.item_id}`)} data-v-cd3c9118>`);
            _push(ssrRenderComponent(_component_ContentRenderer, {
              content: getContentForMenuItem(child.item_id),
              "domain-id": __props.domain.domain_id
            }, null, _parent));
          ...
          _push(`<div class="section-body" data-v-cd3c9118>`);
          _push(ssrRenderComponent(_component_ContentRenderer, {
            content: getContentForMenuItem(menuItem.item_id),
            "domain-id": __props.domain.domain_id
          }, null, _parent));
      ...
      _push(`<!--]--></div><aside class="content-sidebar" data-v-cd3c9118><div class="sidebar-card" data-v-cd3c9118><h3 class="sidebar-title" data-v-cd3c9118>Sections</h3><ul class="sidebar-nav" data-v-cd3c9118><!--[-->`);
      ssrRenderList(__props.menuTree, (item) => {
        _push(`<li data-v-cd3c9118><a${ssrRenderAttr("href", `#section-${item.item_id}`)} data-v-cd3c9118>${ssrInterpolate(item.item_name)}</a></li>`);
      });
      _push(`<!--]--></ul></div>`);
      if (__props.socialMedia && __props.socialMedia.length > 0) {
        _push(`<div class="sidebar-card" data-v-cd3c9118><h3 class="sidebar-title" data-v-cd3c9118>Follow Us</h3><div class="sidebar-social" data-v-cd3c9118><!--[-->`);
        ssrRenderList(__props.socialMedia, (social) => {
          _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-btn" data-v-cd3c9118><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-cd3c9118></i></a>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (__props.settings) {
        _push(`<div class="sidebar-card" data-v-cd3c9118><h3 class="sidebar-title" data-v-cd3c9118>Contact</h3><div class="sidebar-contact" data-v-cd3c9118>`);
        if (__props.domain.company_name) {
          _push(`<p data-v-cd3c9118>${ssrInterpolate(__props.domain.company_name)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.domain.phone_number) {
          _push(`<p data-v-cd3c9118><i class="pi pi-phone" data-v-cd3c9118></i> ${ssrInterpolate(__props.domain.phone_number)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.domain.email) {
          _push(`<p data-v-cd3c9118><i class="pi pi-envelope" data-v-cd3c9118></i> ${ssrInterpolate(__props.domain.email)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
const MagazineGrid = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cd3c9118"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-22226d87>`);
      if (unref(showBanners)) {
        _push(`<section class="${ssrRenderClass([unref(bannerPosClass), "hero-section"])}" data-v-22226d87><div class="hero-background" style="${ssrRenderStyle({ backgroundImage: unref(heroBanner) ? `url(${unref(photoUrl)}${unref(heroBanner).photo})` : "" })}" data-v-22226d87></div><div class="hero-overlay" data-v-22226d87></div><div class="hero-content" data-v-22226d87><div class="hero-badge" data-v-22226d87>${ssrInterpolate(__props.settings.domain_name || "")}</div><h1 class="hero-title" data-v-22226d87>${ssrInterpolate(__props.settings.title || __props.settings.domain_name)}</h1>`);
        if (__props.settings.company_desc) {
          _push(`<p class="hero-subtitle" data-v-22226d87>${ssrInterpolate(__props.settings.company_desc)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button class="hero-cta" data-v-22226d87> Discover <i class="pi pi-arrow-down" data-v-22226d87></i></button></div><div class="scroll-hint" data-v-22226d87><div class="scroll-line" data-v-22226d87></div></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="panels-container" data-v-22226d87><!--[-->`);
      ssrRenderList(__props.menuTree, (menuItem, index2) => {
        _push(`<section class="${ssrRenderClass([{ "panel-dark": index2 % 2 === 1 }, "panel"])}"${ssrRenderAttr("id", `section-${menuItem.item_id}`)} data-v-22226d87><div class="panel-inner" data-v-22226d87><div class="panel-label" data-v-22226d87><span class="label-line" data-v-22226d87></span><span class="label-text" data-v-22226d87>Section ${ssrInterpolate(index2 + 1)}</span></div><h2 class="panel-title" data-v-22226d87>${ssrInterpolate(menuItem.item_name)}</h2>`);
        if (menuItem.children && menuItem.children.length > 0) {
          _push(`<div class="panel-grid" data-v-22226d87><!--[-->`);
          ssrRenderList(menuItem.children, (child) => {
            _push(`<div class="panel-card"${ssrRenderAttr("id", `subsection-${child.item_id}`)} data-v-22226d87>`);
            _push(ssrRenderComponent(_component_ContentRenderer, {
              content: getContentForMenuItem(child.item_id),
              "domain-id": __props.domain.domain_id
            }, null, _parent));
          ...
          _push(`<div class="panel-body" data-v-22226d87>`);
          _push(ssrRenderComponent(_component_ContentRenderer, {
            content: getContentForMenuItem(menuItem.item_id),
            "domain-id": __props.domain.domain_id
          }, null, _parent));
      ...
      _push(`<!--]--></div><div class="nav-dots" data-v-22226d87><!--[-->`);
      ssrRenderList(__props.menuTree, (menuItem, index2) => {
        _push(`<a${ssrRenderAttr("href", `#section-${menuItem.item_id}`)} class="${ssrRenderClass([{ active: unref(activeSection) === menuItem.item_id }, "nav-dot"])}"${ssrRenderAttr("title", menuItem.item_name)} data-v-22226d87></a>`);
      });
      _push(`<!--]--></div>`);
      if (__props.socialMedia.length > 0) {
        _push(`<section class="social-footer" data-v-22226d87><div class="social-inner" data-v-22226d87><!--[-->`);
        ssrRenderList(__props.socialMedia, (social) => {
          _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon-link" data-v-22226d87><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-22226d87></i></a>`);
        });
        _push(`<!--]--></div></section>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(showBackToTop)) {
        _push(`<button class="back-to-top" data-v-22226d87><i class="pi pi-arrow-up" data-v-22226d87></i></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const FullscreenHero = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-22226d87"]]);
...
//# sourceMappingURL=index-CGcWKTH5.mjs.map
