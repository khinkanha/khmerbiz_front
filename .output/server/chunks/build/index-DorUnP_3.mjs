import { defineComponent, computed, ref, watch, resolveComponent, unref, mergeProps, createVNode, resolveDynamicComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderVNode, ssrRenderClass, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { u as useDomainStore } from './domain-CF4nfyOM.mjs';
import { u as useDesignStore, g as getSocialIcon } from './setting-B7aDaTtz.mjs';
import { _ as __nuxt_component_2 } from './BannerSlideshow-Dq6leQiC.mjs';
import { _ as __nuxt_component_0$1, a as __nuxt_component_1, b as __nuxt_component_2$1, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5, f as __nuxt_component_6 } from './ArticleSection-DKsoq-Ne.mjs';
import { C as ContentType } from './content-KJHlnLiT.mjs';
import { p as parseNewsItem } from './useNewsParser-BRh25yln.mjs';
import { _ as _export_sfc, k as useRoute, b as useRuntimeConfig } from './server.mjs';
import { u as useApi } from './auth-CZZkTxj2.mjs';
import { _ as __nuxt_component_0 } from './ContentRenderer-B1YKWL6l.mjs';
import { c as DesignerPage } from './DesignerPage-BdcSIjyy.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const fetchFeaturedNews = async () => {
      ...
      try {
        const results = await Promise.all(
          newsContentIds.value.map(
            (contentId) => api.get(`/site/feature-news/${contentId}`).then((res) => res.success && res.data ? Array.isArray(res.data) ? res.data : res.data.items || [] : []).catch(() => [])
          )
        );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="main-content" data-v-f3b8ddd2><div class="container" data-v-f3b8ddd2>`);
      if (unref(loading)) {
        _push(`<div class="loading-state" data-v-f3b8ddd2>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`<p data-v-f3b8ddd2>${ssrInterpolate(_ctx.$t("common.loading"))}</p></div>`);
      } else {
        _push(`<!--[-->`);
        if (unref(featuredNews).length > 0) {
          _push(`<section class="section news-section" data-v-f3b8ddd2>`);
          if (unref(paginatedNews).length > 0) {
            _push(`<div class="featured-grid" data-v-f3b8ddd2><!--[-->`);
            ssrRenderList(unref(paginatedNews).slice(0, 2), (news) => {
              _push(`<a href="#" class="featured-card" data-v-f3b8ddd2><div class="featured-card-img" data-v-f3b8ddd2>`);
              if (news.photo) {
                _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-f3b8ddd2>`);
              } else {
                _push(`<div class="img-placeholder" data-v-f3b8ddd2><i class="pi pi-image" data-v-f3b8ddd2></i></div>`);
              }
              _push(`</div><div class="featured-card-body" data-v-f3b8ddd2><h4 class="media-heading" data-v-f3b8ddd2><a href="#" data-v-f3b8ddd2>${ssrInterpolate(news.title)}</a></h4>`);
              if (news.short_description) {
                _push(`<p class="featured-excerpt" data-v-f3b8ddd2>${ssrInterpolate(news.short_description)}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<p class="date" data-v-f3b8ddd2><i class="fa fa-clock-o" data-v-f3b8ddd2></i> ${ssrInterpolate(formatDate(news.publish_date))}</p></div></a>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          ...
          if (unref(paginatedNews).length > 2) {
            _push(`<div class="news-media-list" data-v-f3b8ddd2><!--[-->`);
            ssrRenderList(unref(paginatedNews).slice(2), (news, index2) => {
              _push(`<!--[--><div class="news-media-item" data-v-f3b8ddd2><div class="media-left" data-v-f3b8ddd2><a href="#" data-v-f3b8ddd2>`);
              if (news.photo) {
                _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${news.photo}`)}${ssrRenderAttr("alt", news.title)} data-v-f3b8ddd2>`);
              } else {
                _push(`<div class="img-placeholder small" data-v-f3b8ddd2><i class="pi pi-image" data-v-f3b8ddd2></i></div>`);
              }
              _push(`</a></div><div class="media-body" data-v-f3b8ddd2><h4 class="media-heading" data-v-f3b8ddd2><a href="#" data-v-f3b8ddd2>${ssrInterpolate(news.title)}</a></h4>`);
              if (news.short_description) {
                _push(`<p class="media-excerpt" data-v-f3b8ddd2>${ssrInterpolate(news.short_description)}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<p class="date" data-v-f3b8ddd2><i class="fa fa-clock-o" data-v-f3b8ddd2></i> ${ssrInterpolate(formatDate(news.publish_date))}</p></div></div>`);
              if (index2 < unref(paginatedNews).slice(2).length - 1) {
                _push(`<hr class="news-separator" data-v-f3b8ddd2>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (unref(totalPages) > 1) {
            _push(`<div class="pagination-wrap" data-v-f3b8ddd2><ul class="pagination-list" data-v-f3b8ddd2><li class="${ssrRenderClass([{ disabled: unref(currentPage) === 1 }, "page-item"])}" data-v-f3b8ddd2><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-f3b8ddd2> \xAB </button></li><li class="${ssrRenderClass([{ disabled: unref(currentPage) === 1 }, "page-item"])}" data-v-f3b8ddd2><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === 1) ? " disabled" : ""} data-v-f3b8ddd2> \u2039 </button></li><!--[-->`);
            ssrRenderList(unref(visiblePages), (page) => {
              _push(`<li class="${ssrRenderClass([{ active: page === unref(currentPage) }, "page-item"])}" data-v-f3b8ddd2><button class="page-link" data-v-f3b8ddd2>${ssrInterpolate(page)}</button></li>`);
            });
            _push(`<!--]--><li class="${ssrRenderClass([{ disabled: unref(currentPage) === unref(totalPages) }, "page-item"])}" data-v-f3b8ddd2><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-f3b8ddd2> \u203A </button></li><li class="${ssrRenderClass([{ disabled: unref(currentPage) === unref(totalPages) }, "page-item"])}" data-v-f3b8ddd2><button class="page-link"${ssrIncludeBooleanAttr(unref(currentPage) === unref(totalPages)) ? " disabled" : ""} data-v-f3b8ddd2> \xBB </button></li></ul></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</section>`);
        ...
        if (__props.menuTree[0].children && __props.menuTree[0].children.length > 0) {
          _push(`<section data-v-f3b8ddd2><!--[-->`);
          ssrRenderList(__props.menuTree[0].children, (child) => {
            _push(`<div${ssrRenderAttr("id", `section-${child.item_id}`)} class="sub-section" data-v-f3b8ddd2>`);
            if (getContentForMenuItem(child.item_id)) {
              ...
              } else if (getContentType(child.item_id) === unref(ContentType).PRODUCT) {
          ...
          _push(`<!--]--></section>`);
        } else if (__props.menuTree.length > 0 && getContentForMenuItem(__props.menuTree[0].item_id)) {
          _push(`<section class="section"${ssrRenderAttr("id", `section-${__props.menuTree[0].item_id}`)} data-v-f3b8ddd2>`);
          if (getContentForMenuItem(__props.menuTree[0].item_id)) {
            _push(`<!--[-->`);
            if (getContentType(__props.menuTree[0].item_id) === unref(ContentType).NEWS) {
              _push(ssrRenderComponent(_component_NewsSection, {
                "domain-id": __props.domain.domain_id,
                "content-id": getContentForMenuItem(__props.menuTree[0].item_id).content.content_id
              }, null, _parent));
            } else if (getContentType(__props.menuTree[0].item_id) === unref(ContentType).PHOTO) {
              _push(ssrRenderComponent(_component_PhotoGallery, {
                items: getContentForMenuItem(__props.menuTree[0].item_id).items
              }, null, _parent));
            } else if (getContentType(__props.menuTree[0].item_id) === unref(ContentType).VIDEO) {
              _push(ssrRenderComponent(_component_VideoSection, {
                items: getContentForMenuItem(__props.menuTree[0].item_id).items
              }, null, _parent));
            } else if (getContentType(__props.menuTree[0].item_id) === unref(ContentType).MAP) {
              _push(ssrRenderComponent(_component_MapDisplay, {
                "map-data": parseMapData(getContentForMenuItem(__props.menuTree[0].item_id).content)
              }, null, _parent));
            } else if (getContentType(__props.menuTree[0].item_id) === unref(ContentType).DOCUMENT) {
              _push(ssrRenderComponent(_component_DocumentSection, {
                items: getContentForMenuItem(__props.menuTree[0].item_id).items
              }, null, _parent));
            } else if (getContentType(__props.menuTree[0].item_id) === unref(ContentType).PRODUCT) {
              _push(ssrRenderComponent(_component_ProductCatalog, {
                "content-id": getContentForMenuItem(__props.menuTree[0].item_id).content.content_id,
                "section-title": __props.menuTree[0].item_name || "",
                "section-description": getContentForMenuItem(__props.menuTree[0].item_id).content.title || ""
              }, null, _parent));
            } else {
              _push(ssrRenderComponent(_component_ArticleSection, {
                content: getContentForMenuItem(__props.menuTree[0].item_id).content
              }, null, _parent));
            }
            _push(`<!--]-->`);
          } else {
        ...
        if (__props.socialMedia.length > 0) {
          _push(`<section class="section social-section" data-v-f3b8ddd2><div class="social-links-center" data-v-f3b8ddd2><!--[-->`);
          ssrRenderList(__props.socialMedia, (social) => {
            _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-icon-link" data-v-f3b8ddd2><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-f3b8ddd2></i></a>`);
          });
          _push(`<!--]--></div></section>`);
        } else {
          _push(`<!---->`);
...
const ClassicMultiPage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f3b8ddd2"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const api = useApi();
    const designerSections = computed(() => {
      var _a2;
      var _a, _b, _c;
      return (_a2 = (_c = (_b = (_a = designStore.design) == null ? void 0 : _a.pages) == null ? void 0 : _b.home) == null ? void 0 : _c.sections) != null ? _a2 : [];
    });
    const effectivePageStyle = computed(() => {
      var _a;
      const ps = Number((_a = domainStore.settings) == null ? void 0 : _a.page_style);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProgressSpinner = resolveComponent("ProgressSpinner");
      if (unref(isLoading)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "loading" }, _attrs))} data-v-d13b59b9>`);
        _push(ssrRenderComponent(_component_ProgressSpinner, null, null, _parent));
        _push(`</div>`);
      } else if (unref(showUnderConstruction)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "under-construction" }, _attrs))} data-v-d13b59b9><div class="uc-content" data-v-d13b59b9><div class="uc-icon" data-v-d13b59b9><i class="pi pi-building" data-v-d13b59b9></i></div><h1 class="uc-title" data-v-d13b59b9>${ssrInterpolate(((_a = unref(domainStore).settings) == null ? void 0 : _a.title) || ((_b = unref(domainStore).domain) == null ? void 0 : _b.domain_name) || "Our Website")}</h1><div class="uc-divider" data-v-d13b59b9></div><p class="uc-text" data-v-d13b59b9>Our website is currently under construction.</p><p class="uc-subtext" data-v-d13b59b9>We&#39;re working hard to bring you an amazing experience. Please check back soon!</p></div></div>`);
      } else if (unref(isDesignerMode)) {
        _push(ssrRenderComponent(DesignerPage, mergeProps({
          sections: unref(designerSections),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d13b59b9"]]);

export { index as default };
//# sourceMappingURL=index-DorUnP_3.mjs.map
