...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><p class="h3">${ssrInterpolate(_ctx.$t("userManager.profileSetting"))}</p>`);
...
//# sourceMappingURL=profile-DuC0or6L.mjs.map
