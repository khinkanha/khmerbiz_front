...
import { _ as __nuxt_component_0$2, a as __nuxt_component_1, b as __nuxt_component_2, c as __nuxt_component_3, d as __nuxt_component_4, e as __nuxt_component_5 } from './ArticleSection-CZOwx5Xd.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ContentRenderer = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "magazine-grid" }, _attrs))} data-v-d8f6f560>`);
      if (__props.settings) {
        _push(`<section class="banner-bar" data-v-d8f6f560><div class="banner-bar-inner" data-v-d8f6f560><div class="banner-bar-text" data-v-d8f6f560><h1 class="site-title" data-v-d8f6f560>${ssrInterpolate(__props.settings.title || __props.settings.domain_name)}</h1>`);
        if (__props.settings.company_desc) {
          _push(`<p class="site-desc" data-v-d8f6f560>${ssrInterpolate(__props.settings.company_desc)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (__props.banners.length > 0) {
          _push(`<div class="${ssrRenderClass([{ "multi": __props.banners.length > 1 }, "banner-grid"])}" data-v-d8f6f560><!--[-->`);
          ssrRenderList(__props.banners.slice(0, 3), (banner, i) => {
            _push(`<img${ssrRenderAttr("src", `${unref(photoUrl)}${banner.image}`)}${ssrRenderAttr("alt", banner.title)} class="${ssrRenderClass([{ "span-2": __props.banners.length === 2 && i === 0 }, "banner-img"])}" data-v-d8f6f560>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<!---->`);
      ...
      _push(`<main class="main-content" data-v-d8f6f560><div class="content-layout" data-v-d8f6f560><div class="content-main" data-v-d8f6f560><!--[-->`);
      ssrRenderList(__props.menuTree, (menuItem, index2) => {
        _push(`<div class="magazine-section"${ssrRenderAttr("id", `section-${menuItem.item_id}`)} data-v-d8f6f560><div class="section-header" data-v-d8f6f560><h2 class="section-title" data-v-d8f6f560>${ssrInterpolate(menuItem.item_name)}</h2><span class="section-tag" data-v-d8f6f560>${ssrInterpolate(menuItem.item_name)}</span></div>`);
        if (menuItem.children && menuItem.children.length > 0) {
          _push(`<div class="editorial-grid" data-v-d8f6f560><!--[-->`);
          ssrRenderList(menuItem.children, (child, ci) => {
            _push(`<div class="${ssrRenderClass([{ "card-wide": ci === 0 }, "editorial-card"])}"${ssrRenderAttr("id", `subsection-${child.item_id}`)} data-v-d8f6f560>`);
            _push(ssrRenderComponent(_component_ContentRenderer, {
              content: getContentForMenuItem(child.item_id),
              "domain-id": __props.domain.domain_id
            }, null, _parent));
          ...
          _push(`<div class="section-body" data-v-d8f6f560>`);
          _push(ssrRenderComponent(_component_ContentRenderer, {
            content: getContentForMenuItem(menuItem.item_id),
            "domain-id": __props.domain.domain_id
          }, null, _parent));
      ...
      _push(`<!--]--></div><aside class="content-sidebar" data-v-d8f6f560><div class="sidebar-card" data-v-d8f6f560><h3 class="sidebar-title" data-v-d8f6f560>Sections</h3><ul class="sidebar-nav" data-v-d8f6f560><!--[-->`);
      ssrRenderList(__props.menuTree, (item) => {
        _push(`<li data-v-d8f6f560><a${ssrRenderAttr("href", `#section-${item.item_id}`)} data-v-d8f6f560>${ssrInterpolate(item.item_name)}</a></li>`);
      });
      _push(`<!--]--></ul></div>`);
      if (__props.socialMedia && __props.socialMedia.length > 0) {
        _push(`<div class="sidebar-card" data-v-d8f6f560><h3 class="sidebar-title" data-v-d8f6f560>Follow Us</h3><div class="sidebar-social" data-v-d8f6f560><!--[-->`);
        ssrRenderList(__props.socialMedia, (social) => {
          _push(`<a${ssrRenderAttr("href", social.link)} target="_blank" rel="noopener noreferrer" class="social-btn" data-v-d8f6f560><i class="${ssrRenderClass(unref(getSocialIcon)(social.stype))}" data-v-d8f6f560></i></a>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (__props.settings) {
        _push(`<div class="sidebar-card" data-v-d8f6f560><h3 class="sidebar-title" data-v-d8f6f560>Contact</h3><div class="sidebar-contact" data-v-d8f6f560>`);
        if (__props.domain.company_name) {
          _push(`<p data-v-d8f6f560>${ssrInterpolate(__props.domain.company_name)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.domain.phone_number) {
          _push(`<p data-v-d8f6f560><i class="pi pi-phone" data-v-d8f6f560></i> ${ssrInterpolate(__props.domain.phone_number)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.domain.email) {
          _push(`<p data-v-d8f6f560><i class="pi pi-envelope" data-v-d8f6f560></i> ${ssrInterpolate(__props.domain.email)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
const MagazineGrid = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d8f6f560"]]);
...
//# sourceMappingURL=index-BmjRP8wQ.mjs.map
